...
public class GeoJsonLineExporterCommand implements Command, Constant {
	...
	private Feature createFeature(StopArea stopArea) {
		...
		properties.put("comment", stopArea.getComment());
		...
		properties.put("longitude", stopArea.getLongitude());
		properties.put("latitude", stopArea.getLatitude());
		properties.put("long_lat_type", stopArea.getLongLatType());
