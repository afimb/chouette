...
@Log4j
@Data
public class ConverterProcessingCommands implements ProcessingCommands, Constant {
	...
	public static class DefaultFactory extends ProcessingCommandsFactory {
		...
		protected ProcessingCommands create() throws IOException {
			ProcessingCommands result = new ConverterProcessingCommands();
			return result;
		}
	}

	static {
		ProcessingCommandsFactory.factories.put(ConverterProcessingCommands.class.getName(),
				new DefaultFactory());
	}
