...
import amivif.schema.PTAccessPointTypeType;

/**
 * Class PTAccessPointTypeTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class PTAccessPointTypeTypeDescriptor extends amivif.schema.descriptors.PointTypeTypeDescriptor {
    ...
    public PTAccessPointTypeTypeDescriptor() {
        super();
        setExtendsWithoutFlatten(new amivif.schema.descriptors.PointTypeTypeDescriptor());
        _nsURI = "http://www.trident.org/schema/trident";
        _xmlName = "PTAccessPointType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                PTAccessPointTypeType target = (PTAccessPointTypeType) object;
        ...
        //-- _type
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(amivif.schema.types.TypeType.class, "_type", "type", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PTAccessPointTypeType target = (PTAccessPointTypeType) object;
                    target.setType( (amivif.schema.types.TypeType) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        handler = new org.exolab.castor.xml.handlers.EnumFieldHandler(amivif.schema.types.TypeType.class, handler);
        desc.setImmutable(true);
        desc.setSchemaType("amivif.schema.types.TypeType");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.trident.org/schema/trident");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        desc.setValidator(fieldValidator);
        //-- _openingTime
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.exolab.castor.types.Time.class, "_openingTime", "openingTime", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PTAccessPointTypeType target = (PTAccessPointTypeType) object;
                    target.setOpeningTime( (org.exolab.castor.types.Time) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        //-- validation code for: _openingTime
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        ...
        desc.setValidator(fieldValidator);
        //-- _closingTime
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.exolab.castor.types.Time.class, "_closingTime", "closingTime", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PTAccessPointTypeType target = (PTAccessPointTypeType) object;
                    target.setClosingTime( (org.exolab.castor.types.Time) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        //-- validation code for: _closingTime
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
            org.exolab.castor.xml.validators.DateTimeValidator typeValidator;
            typeValidator = new org.exolab.castor.xml.validators.DateTimeValidator();
        ...
        desc.setValidator(fieldValidator);
        //-- _AMIVIF_AccessPoint_Extension
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(amivif.schema.AMIVIF_AccessPoint_Extension.class, "_AMIVIF_AccessPoint_Extension", "AMIVIF_AccessPoint_Extension", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                PTAccessPointTypeType target = (PTAccessPointTypeType) object;
                return target.getAMIVIF_AccessPoint_Extension();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PTAccessPointTypeType target = (PTAccessPointTypeType) object;
                    target.setAMIVIF_AccessPoint_Extension( (amivif.schema.AMIVIF_AccessPoint_Extension) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setSchemaType("amivif.schema.AMIVIF_AccessPoint_Extension");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.trident.org/schema/trident");
        ...
        //-- validation code for: _AMIVIF_AccessPoint_Extension
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
    ...
    public java.lang.Class getJavaClass(
        ...
        return amivif.schema.PTAccessPointTypeType.class;
    }
