...
import amivif.schema.MeasurementTimeTypeType;
...
public class MeasurementTimeTypeTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public MeasurementTimeTypeTypeDescriptor() {
        ...
        //-- _measurementPeriod
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(amivif.schema.MeasurementPeriod.class, "_measurementPeriod", "measurementPeriod", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    MeasurementTimeTypeType target = (MeasurementTimeTypeType) object;
                    target.setMeasurementPeriod( (amivif.schema.MeasurementPeriod) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setSchemaType("amivif.schema.MeasurementPeriod");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.trident.org/schema/trident");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
    ...
    public java.lang.Class getJavaClass(
        ...
        return amivif.schema.MeasurementTimeTypeType.class;
    }
