...
implements java.io.Serializable
{
     ...
     * Field _unit.
     */
    private amivif.schema.types.UnitType _unit;

    /**
     * Field _accuracy.
     */
    private amivif.schema.Accuracy _accuracy;

    /**
     * Field _measurementTime.
     */
    private amivif.schema.MeasurementTime _measurementTime;

    /**
     * Field _measurementLocation.
     */
    private amivif.schema.MeasurementLocation _measurementLocation;
     ...
     */
    public amivif.schema.Accuracy getAccuracy(
    ) {
     ...
     */
    public amivif.schema.MeasurementLocation getMeasurementLocation(
    ) {
     ...
     */
    public amivif.schema.MeasurementTime getMeasurementTime(
    ) {
     ...
     */
    public amivif.schema.types.UnitType getUnit(
    ) {
        return this._unit;
    }
    ...
    public void setAccuracy(
            final amivif.schema.Accuracy accuracy) {
    ...
    public void setMeasurementLocation(
            final amivif.schema.MeasurementLocation measurementLocation) {
    ...
    public void setMeasurementTime(
            final amivif.schema.MeasurementTime measurementTime) {
     ...
     */
    public void setUnit(
            final amivif.schema.types.UnitType unit) {
        this._unit = unit;
    }
