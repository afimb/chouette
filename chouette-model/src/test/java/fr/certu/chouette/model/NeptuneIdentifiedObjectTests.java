...
public class NeptuneIdentifiedObjectTests extends
      AbstractTestNGSpringContextTests
{
   ...
   public void verifyObjectIdSyntax()
   {
      ...
      Assert.assertTrue(NeptuneIdentifiedObject.checkObjectId(oid), oid
            + "should be valid");
      oid = "Test_1:Lin_e:12_abz-Ae-09";
      Assert.assertTrue(NeptuneIdentifiedObject.checkObjectId(oid), oid
            + "should be valid");
      oid = "Test/1:Line:12_abz-Ae-09";
      Assert.assertFalse(NeptuneIdentifiedObject.checkObjectId(oid), oid
            + "should not be valid");
      oid = "Test/1:Line:12_abz-Ae-09";
      Assert.assertFalse(NeptuneIdentifiedObject.checkObjectId(oid), oid
            + "should not be valid");
