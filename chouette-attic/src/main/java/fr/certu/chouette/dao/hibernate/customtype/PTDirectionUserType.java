...
//----------------------------------------------------------------------------
/**
 * Type de donne bas sur l'numration PTDirection
 * 
 ...
 */
//----------------------------------------------------------------------------
public class PTDirectionUserType implements UserType 
{
	//------------------------------------------------------------
			...
			throws HibernateException, SQLException 
	{
		...
		return resultSet.wasNull() ? null : PTDirectionType.fromValue(name);	
	}
	/* (non-Javadoc)
