 ...
 *
 * DPOITypeUserType.java : Type de donne bas sur l'numration LocationReferencingMethodType
 *
...
//----------------------------------------------------------------------------
/**
 * Type de donne bas sur l'numration LocationReferencingMethodType
 * 
 ...
 */
//----------------------------------------------------------------------------
public class ReferencingMethodUserType implements UserType 
{
	//------------------------------------------------------------
			...
			throws HibernateException, SQLException 
	{
		...
		return resultSet.wasNull() ? null : LocationReferencingMethodType.fromValue(name);	
	}
	/* (non-Javadoc)
   ...
   public int hashCode(Object x) throws HibernateException {
	...
	public Class returnedClass() {
		return LocationReferencingMethodType.class;
	}
	/* (non-Javadoc)
