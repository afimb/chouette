...
ALTER TABLE chouette_gui.routing_constraints OWNER TO chouette;
...
CREATE SEQUENCE routing_constraints_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE chouette_gui.routing_constraints_id_seq OWNER TO chouette;
...
ALTER SEQUENCE routing_constraints_id_seq OWNED BY routing_constraints.id;
...
-- Name: routing_constraints_stop_areas; Type: TABLE; Schema: chouette_gui; Owner: chouette; Tablespace:
--

CREATE TABLE routing_constraints_stop_areas (
    routing_constraint_id bigint,
    stop_area_id bigint
);


ALTER TABLE chouette_gui.routing_constraints_stop_areas OWNER TO chouette;
...
--
-- TOC entry 3969 (class 2604 OID 939625)
-- Name: id; Type: DEFAULT; Schema: chouette_gui; Owner: chouette
--

ALTER TABLE ONLY routing_constraints ALTER COLUMN id SET DEFAULT nextval('routing_constraints_id_seq'::regclass);
...
ALTER TABLE ONLY routes
    ...
    --
    -- TOC entry 4045 (class 2606 OID 939729)
    -- Name: routing_constraints_pkey; Type: CONSTRAINT; Schema: chouette_gui; Owner: chouette; Tablespace:
    --

    ALTER TABLE ONLY routing_constraints
        ADD CONSTRAINT routing_constraints_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY routing_constraints_lines
    ADD CONSTRAINT routingconstraint_stoparea_fkey FOREIGN KEY (routing_constraint_id) REFERENCES routing_constraints(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY routing_constraints_stop_areas
    ADD CONSTRAINT routingconstraint_stoparea_routingconstraint_fkey FOREIGN KEY (routing_constraint_id) REFERENCES routing_constraints(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY routing_constraints_stop_areas
    ADD CONSTRAINT routingconstraint_stoparea_stoparea_fkey FOREIGN KEY (stop_area_id) REFERENCES stop_areas(id) ON DELETE CASCADE;
