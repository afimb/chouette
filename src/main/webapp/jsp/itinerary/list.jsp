...
<s:url id="urlItineraires" action="list" namespace="/itinerary" includeParams="none">
...
<%-- Ajouter itinéraire --%>
<div>
  <s:url id="editItineraire" action="add" namespace="/itinerary" includeParams="none">
    <s:param name="idLigne" value="%{idLigne}" />
  </s:url>
  ...
  <TABLE>
    ...
    TRParityClass = "even";
        ...
        <TR class="${TRParityClass}">
          <TD class="${cssBordure}">
            <s:url id="editUrl" action="edit"  namespace="/itinerary">
            ...
            <s:url id="removeUrl" action="delete" namespace="/itinerary">
              <s:param name="idItineraire" value="id" />
              <s:param name="idLigne" value="idLigne"/>
          ...
          <TD class="${cssBordure}">
            <s:if test="!isArretsVide(id)">
              <s:url id="horairesDePassage" action="list" namespace="/horairesDePassage">
                <s:param name="idItineraire" value="id" />
