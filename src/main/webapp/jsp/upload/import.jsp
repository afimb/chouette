...
<s:url id="urlImports" action="execute" namespace="/import" includeParams="none"/>
...
<div>
	...
	<FIELDSET align="center" style="width: 500px;"> 
		...
		<s:form id="uploadCSVForm" action="importCSV" namespace="/import" enctype="multipart/form-data" method="POST">
	...
	<FIELDSET align="center" style="width: 500px;"> 
	   <LEGEND><b><s:text name="fieldset.legend.import.xml"/></b></LEGEND> 
		<s:form id="uploadXMLForm" action="importXML" namespace="/import" enctype="multipart/form-data" method="POST">
		   <s:file name="fichier" label="%{getText('action.browse')}" />
	...
	<FIELDSET align="center" style="width: 500px;"> 
	   <LEGEND><b><s:text name="fieldset.legend.import.multi.xml"/></b></LEGEND> 
		<s:form id="uploadXMLForm" action="importXMLs" namespace="/import" enctype="multipart/form-data" method="POST">
		   <s:file name="fichier" label="%{getText('action.browse')}" />
		   <s:hidden name="fichierContentType" value="text/xml; charset=UTF-8"/>
	...
	<FIELDSET align="center" style="width: 500px;"> 
		...
		<s:form id="uploadAltibusForm" action="importAltibus" namespace="/import" enctype="multipart/form-data" method="POST">
		     <s:file name="fichier" label="%{getText('action.browse')}"/>
		     <s:hidden name="fichierContentType" value="text/csv; charset=UTF-8"/>
	...
	<FIELDSET align="center" style="width: 500px;"> 
	   <LEGEND><b><s:text name="fieldset.legend.import.multi.csv"/></b></LEGEND> 
		<s:form id="uploadCSVGenericForm" action="importCSVGeneric" namespace="/import" enctype="multipart/form-data" method="POST">
		   <s:file name="fichier" label="%{getText('action.browse')}" />
		   <s:hidden name="fichierContentType" value="text/xml; charset=UTF-8"/>
	...
	<FIELDSET align="center" style="width: 500px;"> 
	   <LEGEND><b><s:text name="fieldset.legend.import.hastus"/></b></LEGEND> 
		<s:form id="uploadHastusForm" enctype="multipart/form-data" method="POST" namespace="/">
		   ...
		   <s:submit value="%{getText('submit.import.hastus')}" formId="uploadHastusForm" action="importHastus" namespace="/import"/>
		</s:form>
		<br>
		...
		<s:form id="uploadHastusForm2" enctype="multipart/form-data" method="POST" namespace="/">
		   ...
		   <s:submit value="%{getText('submit.import.incr.hastus')}" formId="uploadHastusForm2" action="importHastus" namespace="/import"/>
		</s:form>
	</FIELDSET>
	<br><br>
	</s:if>
	...
	<FIELDSET align="center" style="width: 500px;"> 
	   <LEGEND><b><s:text name="fieldset.legend.import.xml.stif"/></b></LEGEND> 
		<s:form id="uploadAMIVIFForm" action="importAmivifXML" namespace="/import" enctype="multipart/form-data" method="POST">
		   <s:file name="fichier" label="%{getText('action.browse')}" />
		   <s:hidden name="fichierContentType" value="text/xml; charset=UTF-8"/>
	...
	<FIELDSET align="center" style="width: 500px;"> 
		...
		<s:form id="uploadPegaseForm" action="importPegase" namespace="/import" enctype="multipart/form-data" method="POST">
		     <s:file name="fichier" label="%{getText('action.browse')}"/>
		     <s:hidden name="fichierContentType" value="text/csv; charset=UTF-8"/>
