...
<s:url id="urlITLUpdate" action="edit" namespace="/itl">
...
<div class="panel">
  <s:form cssClass="panelDataInnerForm" namespace="/itl">
    ...
    <s:else>
      <s:select key="itl.idLigne"  list="lignes" listKey="id" listValue="fullName" required="true"/>
    </s:else>
...
<div class="panel">
  <s:if test="itl.id != null && itl.idLigne != null">
    ...
    <div ID="divSearchArret" STYLE="border: 1px; border-color: black;">
      <s:form cssClass="panelDataInnerForm" action="addStop" namespace="/itl" id="creerArretForm" theme="simple">
        <table><tr>
            <td>
              <s:if test="itl.id != null">
