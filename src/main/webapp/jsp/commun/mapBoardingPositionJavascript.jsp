...
<script language="JavaScript" type="text/javascript" src="<s:url value='http://api.ign.fr/geoportail/api?v=1.0-m&key=2128847081004116687&includeEngine=true' includeParams='none'/>" ></script>
