...
<script language="JavaScript" type="text/javascript" src="<s:url value='http://api.ign.fr/geoportail/api?v=1.0-m&key=5236411550476476366&includeEngine=true' includeParams='none'/>" ></script>
