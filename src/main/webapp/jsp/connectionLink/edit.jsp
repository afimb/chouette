...
<div class="panel">
  <s:form id="connectionLinkForm"  namespace="/connectionLink">
    ...
    <s:select emptyOption="false" key="linkType" list="@fr.certu.chouette.struts.enumeration.EnumerationApplication@getConnectionLinkTypeEnum()" listKey="enumeratedTypeAccess" listValue="textePropriete"/>
