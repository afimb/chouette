...
<s:url id="urlHorairesDePassages" action="/horairesDePassage/list" includeParams="none">
...
<div>
  <s:url id="editCourse" value="/course/edit"/>
...
<s:if test="arretsItineraire.size > 0 && coursesPage.size >= 0">	
  ...
  <div id="filtrageTableauMarche">
    <s:form action="/horairesDePassage/list" id="filtrageTableauMarcheForm">
