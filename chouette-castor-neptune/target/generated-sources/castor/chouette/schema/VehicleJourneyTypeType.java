...
public abstract class VehicleJourneyTypeType extends chouette.schema.TridentObjectTypeType 
implements java.io.Serializable
{
     ...
     */
    private chouette.schema.types.TransportModeNameType _transportMode;
     ...
     * Field _statusValue.
     */
    private chouette.schema.types.ServiceStatusValueType _statusValue;
     ...
     */
    private java.util.List<chouette.schema.VehicleJourneyAtStop> _vehicleJourneyAtStopList;
    ...
    public VehicleJourneyTypeType() {
        super();
        this._vehicleJourneyAtStopList = new java.util.ArrayList<chouette.schema.VehicleJourneyAtStop>();
    }
    ...
    public void addVehicleJourneyAtStop(
            final chouette.schema.VehicleJourneyAtStop vVehicleJourneyAtStop)
     ...
     * collection
     */
    public java.util.Enumeration<? extends chouette.schema.VehicleJourneyAtStop> enumerateVehicleJourneyAtStop(
    ) {
     ...
     */
    public chouette.schema.types.ServiceStatusValueType getStatusValue(
    ) {
        return this._statusValue;
    }

    /**
     * Returns the value of field 'timeSlotId'.
     * 
     * @return the value of field 'TimeSlotId'.
     */
     ...
     */
    public chouette.schema.types.TransportModeNameType getTransportMode(
    ) {
     ...
     * chouette.schema.VehicleJourneyAtStop at the given index
     */
    public chouette.schema.VehicleJourneyAtStop getVehicleJourneyAtStop(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (chouette.schema.VehicleJourneyAtStop) _vehicleJourneyAtStopList.get(index);
    }
    ...
    public chouette.schema.VehicleJourneyAtStop[] getVehicleJourneyAtStop(
        ...
        chouette.schema.VehicleJourneyAtStop[] array = new chouette.schema.VehicleJourneyAtStop[0];
        return (chouette.schema.VehicleJourneyAtStop[]) this._vehicleJourneyAtStopList.toArray(array);
    }
     ...
     */
    public java.util.List<chouette.schema.VehicleJourneyAtStop> getVehicleJourneyAtStopAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends chouette.schema.VehicleJourneyAtStop> iterateVehicleJourneyAtStop(
    ) {
     ...
     */
    public chouette.schema.VehicleJourneyAtStop removeVehicleJourneyAtStopAt(
            final int index) {
        java.lang.Object obj = this._vehicleJourneyAtStopList.remove(index);
        return (chouette.schema.VehicleJourneyAtStop) obj;
    }
    ...
    public void setStatusValue(
            final chouette.schema.types.ServiceStatusValueType statusValue) {
        this._statusValue = statusValue;
    }

    /**
     * Sets the value of field 'timeSlotId'.
     * 
     * @param timeSlotId the value of field 'timeSlotId'.
     */
    public void setTimeSlotId(
            final java.lang.String timeSlotId) {
    ...
    public void setTransportMode(
            final chouette.schema.types.TransportModeNameType transportMode) {
     ...
     */
    public void setVehicleJourneyAtStop(
            final chouette.schema.VehicleJourneyAtStop[] vVehicleJourneyAtStopArray) {
        //-- copy array
     ...
     */
    public void setVehicleJourneyAtStop(
            final java.util.List<chouette.schema.VehicleJourneyAtStop> vVehicleJourneyAtStopList) {
        // copy vector
        this._vehicleJourneyAtStopList.clear();
    ...
    public void setVehicleJourneyAtStopAsReference(
            final java.util.List<chouette.schema.VehicleJourneyAtStop> vehicleJourneyAtStopList) {
