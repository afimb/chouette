...
public abstract class TimetableTypeType extends chouette.schema.TridentObjectTypeType 
implements java.io.Serializable
{
     ...
     * Field _periodList.
     */
    private java.util.List<chouette.schema.Period> _periodList;
     ...
     * Field _dayTypeList.
     */
    private java.util.List<chouette.schema.types.DayTypeType> _dayTypeList;
    ...
    public TimetableTypeType() {
        super();
        this._periodList = new java.util.ArrayList<chouette.schema.Period>();
        this._calendarDayList = new java.util.ArrayList<org.exolab.castor.types.Date>();
        this._dayTypeList = new java.util.ArrayList<chouette.schema.types.DayTypeType>();
    ...
    public void addDayType(
            final chouette.schema.types.DayTypeType vDayType)
    throws java.lang.IndexOutOfBoundsException {
    ...
    public void addPeriod(
            final chouette.schema.Period vPeriod)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<? extends chouette.schema.types.DayTypeType> enumerateDayType(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<? extends chouette.schema.Period> enumeratePeriod(
    ) {
     ...
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the chouette.schema.types.DayTypeType
     * at the given index
     */
    public chouette.schema.types.DayTypeType getDayType(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (chouette.schema.types.DayTypeType) _dayTypeList.get(index);
    }
    ...
    public chouette.schema.types.DayTypeType[] getDayType(
        ...
        chouette.schema.types.DayTypeType[] array = new chouette.schema.types.DayTypeType[0];
        return (chouette.schema.types.DayTypeType[]) this._dayTypeList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<chouette.schema.types.DayTypeType> getDayTypeAsReference(
    ) {
     ...
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the chouette.schema.Period at the given
     * index
     */
    public chouette.schema.Period getPeriod(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (chouette.schema.Period) _periodList.get(index);
    }
    ...
    public chouette.schema.Period[] getPeriod(
        ...
        chouette.schema.Period[] array = new chouette.schema.Period[0];
        return (chouette.schema.Period[]) this._periodList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<chouette.schema.Period> getPeriodAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends chouette.schema.types.DayTypeType> iterateDayType(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends chouette.schema.Period> iteratePeriod(
    ) {
     ...
     * @return the element removed from the collection
     */
    public chouette.schema.types.DayTypeType removeDayTypeAt(
            final int index) {
        java.lang.Object obj = this._dayTypeList.remove(index);
        return (chouette.schema.types.DayTypeType) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public chouette.schema.Period removePeriodAt(
            final int index) {
        java.lang.Object obj = this._periodList.remove(index);
        return (chouette.schema.Period) obj;
    }
     ...
     */
    public void setDayType(
            final chouette.schema.types.DayTypeType[] vDayTypeArray) {
        //-- copy array
        _dayTypeList.clear();
     ...
     */
    public void setDayType(
            final java.util.List<chouette.schema.types.DayTypeType> vDayTypeList) {
        // copy vector
        this._dayTypeList.clear();
    ...
    public void setDayTypeAsReference(
            final java.util.List<chouette.schema.types.DayTypeType> dayTypeList) {
     ...
     */
    public void setPeriod(
            final chouette.schema.Period[] vPeriodArray) {
        //-- copy array
        _periodList.clear();
     ...
     */
    public void setPeriod(
            final java.util.List<chouette.schema.Period> vPeriodList) {
        // copy vector
        this._periodList.clear();
    ...
    public void setPeriodAsReference(
            final java.util.List<chouette.schema.Period> periodList) {
