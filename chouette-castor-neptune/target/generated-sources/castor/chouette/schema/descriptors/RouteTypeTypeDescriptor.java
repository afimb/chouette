...
import chouette.schema.RouteTypeType;
 ...
 */
public class RouteTypeTypeDescriptor extends chouette.schema.descriptors.TridentObjectTypeTypeDescriptor {
    ...
    public RouteTypeTypeDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _direction
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(chouette.schema.types.PTDirectionType.class, "_direction", "direction", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    RouteTypeType target = (RouteTypeType) object;
                    target.setDirection( (chouette.schema.types.PTDirectionType) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setImmutable(true);
        desc.setSchemaType("chouette.schema.types.PTDirectionType");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.trident.org/schema/trident");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
    ...
    public java.lang.Class getJavaClass(
        ...
        return chouette.schema.RouteTypeType.class;
    }
