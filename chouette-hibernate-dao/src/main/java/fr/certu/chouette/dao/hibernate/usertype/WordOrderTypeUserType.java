...
import fr.certu.chouette.model.neptune.type.WordOrderEnum;
...
public class WordOrderTypeUserType implements UserType
{
         ...
         throws HibernateException, SQLException
   {
      ...
      return resultSet.wasNull() ? null : WordOrderEnum.fromValue(name);
   }

   public void nullSafeSet(PreparedStatement statement, Object value, int index, SessionImplementor arg2)
         throws HibernateException, SQLException
   {
      if (value == null)
      {
