...
//----------------------------------------------------------------------------
/**
 * Type de donnee base sur l'enumration AccessPointTypeEnum. <p>
 * 
 ...
 */
//----------------------------------------------------------------------------
public class AccessPointTypeUserType implements UserType 
{
	//------------------------------------------------------------
			...
			throws HibernateException, SQLException 
	{
		...
		return resultSet.wasNull() ? null : AccessPointTypeEnum.fromValue(name);	
	}
	/* (non-Javadoc)
   ...
   public int hashCode(Object x) throws HibernateException {
	...
	public Class returnedClass() {
		return AccessPointTypeEnum.class;
	}
	/* (non-Javadoc)
