 ...
 *
 * DPTDirectionUserType.java : Type de donne bas sur l'numration PTDirection
 *
 * Historique des modifications :
 * Date        | Auteur         | Libll
 * ------------+----------------+-----------------------------------------------
 * 5 nov. 2004 |Marc FLORISSON  | Cration
 * ------------+----------------+-----------------------------------------------
 */
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
/**
 * Type de donne bas sur l'numration PTNetworkSourceType
 * 
 ...
 */
//----------------------------------------------------------------------------
public class PTNetworkSourceUserType implements UserType 
{
	//------------------------------------------------------------
			...
			throws HibernateException, SQLException 
	{
		...
		return resultSet.wasNull() ? null : PTNetworkSourceTypeEnum.fromValue(name);	
	}
	/* (non-Javadoc)
   ...
   public int hashCode(Object x) throws HibernateException {
	...
	public Class returnedClass() {
		return PTNetworkSourceTypeEnum.class;
	}
	/* (non-Javadoc)
