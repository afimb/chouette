 ...
 *
 * DDayTypeUserType.java : Type de donne bas sur l'numration DayTypeType
 *
...
//----------------------------------------------------------------------------
/**
 * Type de donne bas sur l'numration DayTypeType. <p>
 * 
 ...
 */
//----------------------------------------------------------------------------
public class DayTypeUserType implements UserType 
{
	//------------------------------------------------------------
			...
			throws HibernateException, SQLException 
	{
		...
		return resultSet.wasNull() ? null : DayTypeEnum.fromValue(name);	
	}
	/* (non-Javadoc)
