 ...
 *
 * DTransportModeNameUserType.java : Type de donne bas sur l'numration TransportModeName
 *
...
//----------------------------------------------------------------------------
/**
 * Type de donne bas sur l'numration TransportModeName
 * 
 ...
 */
//----------------------------------------------------------------------------
public class TransportModeNameUserType implements UserType 
{
	//------------------------------------------------------------
			...
			throws HibernateException, SQLException 
	{
		...
		return resultSet.wasNull() ? null : TransportModeNameEnum.fromValue(name);
	}
	/* (non-Javadoc)
   ...
   public int hashCode(Object x) throws HibernateException {
	...
	public Class returnedClass() {
		return TransportModeNameEnum.class;
	}
	/* (non-Javadoc)
