 ...
 *
 * DLongLatTypeUserType.java : Type de donne bas sur l'numration LongLatType
 *
...
//----------------------------------------------------------------------------
/**
 * Type de donne bas sur l'numration LongLatType. <p>
 * 
 ...
 */
//----------------------------------------------------------------------------
public class ChouettteAreaTypeUserType implements UserType 
{
	//------------------------------------------------------------
			...
			throws HibernateException, SQLException 
	{
		...
		return resultSet.wasNull() ? null : ChouetteAreaEnum.fromValue(name);	
	}
	/* (non-Javadoc)
