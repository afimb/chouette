...
public class NetexFileWriter
{
   ...
   public ZipEntry writeZipEntry(Line line, String entryName,
         ...
         DatatypeConfigurationException
   {
      ...
      // "templates/line.vm", "UTF-8", model, output);
         ...
         DatatypeConfigurationException
   {
      ...
      StringWriter output = new StringWriter();
      VelocityEngineUtils.mergeTemplate(velocityEngine, "templates/line.vm",
            "UTF-8", model, output);
