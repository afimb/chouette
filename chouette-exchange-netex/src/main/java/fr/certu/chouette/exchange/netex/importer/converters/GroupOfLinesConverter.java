...
public class GroupOfLinesConverter extends GenericConverter
{
   private static final Logger logger = Logger
         .getLogger(GroupOfLinesConverter.class);
   private List<GroupOfLine> groups = new ArrayList<GroupOfLine>();
   private AutoPilot pilot;
   private VTDNav nav;

   public GroupOfLinesConverter(VTDNav vTDNav) throws XPathParseException,
   ...
   public List<GroupOfLine> convert() throws XPathEvalException, NavException,
         XPathParseException, ParseException
   {
      ...
      while (pilot.evalXPath() != -1)
      {
         ...
         Object objectVersion = parseOptionnalAttribute(nav, "version",
               "Integer");
         group.setObjectVersion(objectVersion != null ? (Integer) objectVersion
               : 0);
