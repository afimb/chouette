...
public class GenericConverter
{
   ...
   private static final Logger logger = Logger
         .getLogger(GenericConverter.class);
   ...
   {
      nav.toElement(VTDNav.ROOT); // reset the cursor to point to the root
      // element
   }
   ...
   {
      List<DayTypeEnum> dayTypeEnums = new ArrayList<DayTypeEnum>(
            objects.size());
      for (Object object : objects)
      {
         if (object != null)
   ...
   private Object parseData(VTDNav nav, Object type, int position)
         throws ParseException, NavException
   {
      ...
      if (type.toString().equals("Date"))
         ...
         return new Time(durationFactory.newDuration(value).getTimeInMillis(
               new Date()));
   ...
   protected Object parseParentAttribute(VTDNav nav, String attribute,
         Object... params) throws NavException, ParseException
   {
      ...
      {
         String log = "No attribute " + attribute + " found for "
               + this.getClass();
         logger.error(log);
         throw new ExchangeRuntimeException(
               ExchangeExceptionCode.INVALID_NETEX_FILE, log);
      }
   ...
   protected Object parseMandatoryAttribute(VTDNav nav, String attribute,
         Object... params) throws NavException, ParseException
   {
      assert params.length <= 1;
   ...
   protected Object parseMandatoryAttribute(VTDNav nav, String element,
         String attribute, Object... params) throws NavException,
         ParseException
   {
      List<Object> attributes = parseMandatoryAttributes(nav, element,
            attribute, params);
   ...
   protected List<Object> parseMandatoryAttributes(VTDNav nav, String element,
         String attribute, Object... params) throws NavException,
         ParseException
   {
      Object type = params.length > 0 ? params[0].toString() : "String";
   ...
   protected Object parseOptionnalAttribute(VTDNav nav, String attribute,
         Object... params) throws NavException, ParseException
   {
      Object type = params.length > 0 ? params[0].toString() : "String";
      int position = nav.getAttrVal(attribute);
   ...
   protected Object parseOptionnalCAttribute(VTDNav nav, String element,
         String attribute, Object... params) throws NavException,
         ParseException
   {
      List<Object> attributes = parseOptionnalAttributes(nav, element,
            attribute, params);
      if (attributes.isEmpty())
         return null;
      else
   ...
   protected List<Object> parseOptionnalAttributes(VTDNav nav, String element,
         String attribute, Object... params) throws NavException,
         ParseException
   {
      Object type = params.length > 0 ? params[0].toString() : "String";
      ...
      while (pilot.iterate()) // iterate will iterate thru all elements
      {
         ...
         if (position == -1 || nav.toNormalizedString(position) == null)
            logger.debug("No attribute " + attribute + " found for "
                  + this.getClass());
         else
            attributes.add(parseData(nav, type, position));
      }
   ...
   protected Object parseMandatoryElement(VTDNav nav, String element,
         Object... params) throws NavException, ParseException
   {
   ...
   protected List<Object> parseMandatoryElements(VTDNav nav, String element,
         Object... params) throws NavException, ParseException
   {
      Object type = params.length > 0 ? params[0].toString() : "String";
      ...
      while (pilot.iterate()) // iterate will iterate thru all elements
      {
         ...
         if (position == -1 || nav.toNormalizedString(position) == null)
         {
            String log = "No element " + element + " found for "
                  + this.getClass();
            logger.error(log);
            throw new ExchangeRuntimeException(
                  ExchangeExceptionCode.INVALID_NETEX_FILE, log);
   ...
   protected Object parseMandatorySubElement(VTDNav nav, String element,
         String subElement, Object... params) throws NavException,
         ParseException
   {
      List<Object> elements = parseMandatorySubElements(nav, element,
            subElement, params);
      if (elements.isEmpty())
         return null;
      else
   ...
   protected List<Object> parseMandatorySubElements(VTDNav nav, String element,
         String subElement, Object... params) throws NavException,
         ParseException
   {
      Object type = params.length > 0 ? params[0].toString() : "String";
   ...
   protected Object parseOptionnalElement(VTDNav nav, String element,
         Object... params) throws NavException, ParseException
   {
   ...
   protected List<Object> parseOptionnalElements(VTDNav nav, String element,
         Object... params) throws NavException, ParseException
   {
      Object type = params.length > 0 ? params[0].toString() : "String";
      List<Object> elements = new ArrayList<Object>();
      ...
      while (pilot.iterate()) // iterate will iterate thru all elements
      {
         ...
         if (position == -1 || nav.toNormalizedString(position) == null)
         {
            logger.debug("No element " + element + " found for "
                  + this.getClass());
            return elements;
         }
   ...
   public Object parseOptionnalElement(VTDNav nav, AutoPilot pilot,
         String element) throws NavException, ParseException
   {
      pilot.selectElement(element);
      while (pilot.iterate())
      {
   ...
   protected Object parseOptionnalSubElement(VTDNav nav, String element,
         String subElement, Object... params) throws NavException,
         ParseException
   {
      List<Object> elements = parseOptionnalSubElements(nav, element,
            subElement, params);
      if (elements.isEmpty())
         return null;
      else
   ...
   protected List<Object> parseOptionnalSubElements(VTDNav nav, String element,
         String subElement, Object... params) throws NavException,
         ParseException
   {
      Object type = params.length > 0 ? params[0].toString() : "String";
