...
public class VehicleJourneyConverter extends GenericConverter
{
   private static final Logger logger = Logger
         .getLogger(VehicleJourneyConverter.class);
   ...
   public VehicleJourneyConverter(VTDNav vTDNav) throws XPathParseException,
   ...
   public List<VehicleJourney> convert() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      ...
      autoPilot
            .selectXPath("/netex:PublicationDelivery/netex:dataObjects/"
      ...
      while (autoPilot.evalXPath() != -1)
      {
         ...
         // Mandatory
         vehicleJourney
               .setObjectId((String) parseMandatoryAttribute(nav, "id"));
         ...
         vehicleJourney.setPublishedJourneyName((String) parseOptionnalElement(
               nav, "Name"));
         vehicleJourney
         ...
         // Route
         vehicleJourney.setRouteId((String) parseMandatoryAttribute(nav,
               "RouteRef", "ref"));
         // JourneyPattern
         vehicleJourney.setJourneyPatternId((String) parseMandatoryAttribute(
               nav, "ServicePatternRef", "ref"));

         // TimeTables
         List<String> timetablesObjectId = toStringList(parseMandatoryAttributes(
               nav, "DayTypeRef", "ref"));
         String vehicleJourneyObjectId = vehicleJourney.getObjectId();
         timetablesByVehicleJourneyObjectId.put(vehicleJourneyObjectId,
               timetablesObjectId);
         ...
         {
            List<VehicleJourney> vjs = vehicleJourneysByJPObjectId
                  .get(journeyPatternObjectId);
