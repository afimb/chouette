...
public class CompanyConverter extends GenericConverter
{
   ...
   public CompanyConverter(VTDNav vTDNav) throws XPathParseException,
         ...
         XPathParseException, ParseException
   {
      ...
      {
         // Mandatory
         company.setRegistrationNumber((String) parseOptionnalElement(nav,
               "CompanyNumber"));
   ...
   private void convertOrganisationPart() throws XPathParseException,
         NavException, ParseException, XPathEvalException
   {
      nav.push();
   ...
   private void convertDepartment() throws XPathParseException, NavException,
         ParseException, XPathEvalException
   {
      nav.push();
   ...
   private void convertContactDetails() throws XPathParseException,
         NavException, ParseException
   {
      nav.push();
