...
public class JourneyPatternTest extends ChouetteModelTest
{
   ...
   public void verifyServicePatternId() throws XPathExpressionException,
         ParseException
   {
   ...
   public void verifyServicePatternComment() throws XPathExpressionException,
         ParseException
   {
      for (Route route : line.getRoutes())
      {
   ...
   @Test(groups = { "ServiceFrame", "servicePatterns" }, description = "Validate presence of PrivateCode with expected ref")
   public void verifyServicePatternPrivateCode()
   ...
   public void verifyServicePatternShortName() throws XPathExpressionException,
         ParseException
   {
      for (Route route : line.getRoutes())
      {
   ...
   @Test(groups = { "ServiceFrame", "servicePatterns" }, description = "Validate presence of RouteRef with expected ref")
   public void verifyServicePatternName() throws XPathExpressionException,
         ParseException
   {
      for (Route route : line.getRoutes())
      {
      ...
      for (Route route : line.getRoutes())
      {
         for (JourneyPattern journeyPattern : route.getJourneyPatterns())
         {
            ...
            Assert.assertEquals(
                  ...
                  journeyPattern.getVehicleJourneys().size());
