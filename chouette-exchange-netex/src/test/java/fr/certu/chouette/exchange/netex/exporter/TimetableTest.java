...
public class TimetableTest extends ChouetteModelTest
{
   ...
   public void verifyServiceCalendarFrameId() throws XPathExpressionException,
         ParseException
   {
      ...
      {
         String xPathExpr = "boolean(//netex:ServiceCalendarFrame" + "[@id = '"
               + timetable.objectIdPrefix() + ":ServiceCalendarFrame:SFC" + i
               + "'])";
   ...
   public void verifyServiceCalendarId() throws XPathExpressionException,
         ParseException
   {
      ...
      for (Timetable timetable : timetables)
      {
         String xPathExpr = "boolean(//netex:ServiceCalendarFrame"
               + "/netex:ServiceCalendar" + "[@id = '"
               + timetable.objectIdPrefix() + ":ServiceCalendar:SFC" + i
               + "'])";
         assertXPathTrue(xPathExpr);
         i++;
      }
   ...
   public void verifyDayTypeId() throws XPathExpressionException,
         ParseException
   {
      ...
      {
         String xPathExpr = "boolean(//netex:ServiceCalendarFrame"
               + "/netex:dayTypes" + "/netex:DayType" + "[@id = '"
   ...
   public void verifyDayTypeName() throws XPathExpressionException,
         ParseException
   {
      ...
      for (Timetable timetable : timetables)
      {
         String xPathExpr = "boolean(//netex:ServiceCalendarFrame"
               + "/netex:dayTypes" + "/netex:DayType" + "[@id = '"
               + modelTranslator.netexId(timetable) + "']/netex:Name/text()='"
   ...
   public void verifyDayTypeShortName() throws XPathExpressionException,
         ParseException
   {
      ...
      for (Timetable timetable : timetables)
      {
         String xPathExpr = "boolean(//netex:ServiceCalendarFrame"
               + "/netex:dayTypes" + "/netex:DayType" + "[@id = '"
               + modelTranslator.netexId(timetable)
               + "']/netex:ShortName/text()='" + timetable.getComment() + "')";
         assertXPathTrue(xPathExpr);
      }
   }

   @Test(groups = { "ServiceCalendarFrame", "dayTypes" }, description = "Validate presence of DayType with expected properties")
   public void verifyDayTypeProperties() throws XPathExpressionException,
         ParseException
   {
         ...
         for (DayTypeEnum dtenum : timetable.getDayTypes())
         {
            if (enumTranslator.toDayTypeNetex(dtenum) != null)
            {
               String xPathExpr = "boolean(//netex:ServiceCalendarFrame"
                     ...
                     + "netex:DaysOfWeek/" + "text()='" + dtenum.name() + "')";
               assertXPathTrue(xPathExpr);
            }
         }
      }
   ...
   public void verifyOperatingPeriodId() throws XPathExpressionException,
         ParseException
   {
      ...
      for (Timetable timetable : timetables)
      {
         ...
         {
            String xPathExpr = "boolean(//netex:ServiceCalendarFrame"
                  + "/netex:operatingPeriods" + "/netex:OperatingPeriod"
                  + "[@id = '" + timetable.objectIdPrefix()
                  + ":OperatingPeriod:" + timetable.objectIdSuffix() + "S"
                  + dateFormat.format(period.getStartDate()) + "E"
   ...
   public void verifyOperatingPeriodFromDate() throws XPathExpressionException,
         ParseException
   {
      ...
      for (Timetable timetable : timetables)
      {
         for (Period period : timetable.getPeriods())
         {
            String xPathExpr = "boolean(//netex:ServiceCalendarFrame"
                  ...
                  + "/netex:OperatingPeriod/netex:FromDate/" + "text() = '"
   ...
   public void verifyOperatingPeriodToDate() throws XPathExpressionException,
         ParseException
   {
      ...
      for (Timetable timetable : timetables)
      {
         for (Period period : timetable.getPeriods())
         {
            String xPathExpr = "boolean(//netex:ServiceCalendarFrame"
                  + "/netex:operatingPeriods"
                  + "/netex:OperatingPeriod/netex:ToDate/" + "text() = '"
   ...
   public void verifyOperatingDayId() throws XPathExpressionException,
         ParseException
   {
      ...
      for (Timetable timetable : timetables)
      {
         ...
         {
            String xPathExpr = "boolean(//netex:ServiceCalendarFrame"
                  + "/netex:operatingDays" + "/netex:OperatingDay" + "[@id = '"
                  + timetable.objectIdPrefix() + ":OperatingDay:"
                  + timetable.objectIdSuffix() + "D" + dateFormat.format(day)
                  + "']" + ")";
            assertXPathTrue(xPathExpr);
         }
      }
   ...
   public void verifyOperatingDayDay() throws XPathExpressionException,
         ParseException
   {
      ...
      for (Timetable timetable : timetables)
      {
         for (Date day : timetable.getPeculiarDates())
         {
            String xPathExpr = "boolean(//netex:ServiceCalendarFrame"
                  + "/netex:operatingDays"
                  + "/netex:OperatingDay/netex:CalendarDate/" + "text() = '"
   ...
   public void verifyDayTypeAssignment() throws XPathExpressionException,
         ParseException
   {
      ...
      for (Timetable timetable : timetables)
      {
         String xPathExpr = "count(//netex:ServiceCalendarFrame"
               ...
               + "/netex:DayTypeAssignment/netex:DayTypeRef" + "[@ref = '"
               + modelTranslator.netexId(timetable) + "'])";
         assertXPathCount(xPathExpr, timetable.getCalendarDays().size()
   ...
   public void verifyDayTypeAssignmentOperatingPeriodRef()
   ...
   public void verifyDayTypeAssignmentOperatingDayRef()
         throws XPathExpressionException, ParseException
   {
      ...
      for (Timetable timetable : timetables)
      {
         for (Date day : timetable.getPeculiarDates())
         {
            String xPathExpr = "boolean(//netex:ServiceCalendarFrame"
                  ...
                  + "[@ref = '" + timetable.objectIdPrefix() + ":OperatingDay:"
                  + timetable.objectIdSuffix() + "D" + dateFormat.format(day)
                  + "'])";
            assertXPathTrue(xPathExpr);
         }
