...
public class CompanyConverterTests extends AbstractTestNGSpringContextTests
{
   ...
   private static final Logger logger = Logger
         .getLogger(CompanyConverterTests.class);
   ...
   public void verifyId() throws XPathEvalException, NavException,
   ...
   public void verifyCode() throws XPathEvalException, NavException,
         XPathParseException, ParseException
   {
      Company network = companyConverter.convert();
   ...
   public void verifyOrganisationalUnit() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      Company network = companyConverter.convert();
   ...
   public void verifyOperatingDepartmentName() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      Company network = companyConverter.convert();
   ...
   public void verifyEmail() throws XPathEvalException, NavException,
         XPathParseException, ParseException
   {
      Company network = companyConverter.convert();
   ...
   public void verifyPhone() throws XPathEvalException, NavException,
         XPathParseException, ParseException
   {
      Company network = companyConverter.convert();
   ...
   public void verifyFax() throws XPathEvalException, NavException,
         XPathParseException, ParseException
   {
      Company network = companyConverter.convert();
