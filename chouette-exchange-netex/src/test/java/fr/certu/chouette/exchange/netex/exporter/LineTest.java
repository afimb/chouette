...
public class LineTest extends ChouetteModelTest
{
   ...
   {
      assertXPathCount("count(//netex:ServiceFrame/netex:lines/netex:Line)", 1);
   ...
   {
      assertXPathTrue("boolean(//netex:Line[@id = '" + lineId()
   ...
   public void verifyLineComment() throws XPathExpressionException,
         ParseException
   {
      assertXPathTrue("boolean(//netex:Line[@id = '" + lineId()
   ...
   public void verifyLineRegistrationNumber() throws XPathExpressionException,
         ParseException
   {
      assertXPathTrue("boolean(//netex:Line[@id = '" + lineId()
   ...
   public void verifyLineNumber() throws XPathExpressionException,
         ParseException
   {
      assertXPathTrue("boolean(//netex:Line[@id = '" + lineId()
   ...
   public void verifyLinePublishedName() throws XPathExpressionException,
         ParseException
   {
      assertXPathTrue("boolean(//netex:Line[@id = '" + lineId()
