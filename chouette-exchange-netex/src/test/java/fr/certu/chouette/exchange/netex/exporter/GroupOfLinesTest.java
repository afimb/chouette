...
public class GroupOfLinesTest extends ChouetteModelTest
{
   ...
   public void verifyGroupOfLinesId() throws XPathExpressionException,
         ParseException
   {
      assertXPathCount(
            "count(//netex:ServiceFrame/netex:groupsOfLines/netex:GroupOfLines)",
   ...
   public void verifyGroupOfLinesName() throws XPathExpressionException,
         ParseException
   {
      for (GroupOfLine groupOfLine : line.getGroupOfLines())
      {
   ...
   public void verifyGroupOfLinesComment() throws XPathExpressionException,
         ParseException
   {
      for (GroupOfLine groupOfLine : line.getGroupOfLines())
      {
