...
public class StopAreaConverterTests extends AbstractTestNGSpringContextTests
{
   ...
   public void verifyStopAreaConverter() throws XPathEvalException,
   ...
   private StopArea getStopAreaByObjectId(String objectId)
         ...
         ParseException
   {
      ...
      Assert.assertNotNull(selectedStopArea,
            "can't find expected stopArea having " + objectId + " as objectId");
      return selectedStopArea;
   }

   @Test(groups = { "ServiceFrame" }, description = "StopArea's parent fareCode attribute reading")
   public void verifyStopPlaceParentFareCode() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
   ...
   public void verifyStopPlaceFareCode() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
   ...
   public void verifyQuayFareCode() throws XPathEvalException, NavException,
   ...
   public void verifyStopPlaceParent() throws XPathEvalException, NavException,
         XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:StopArea:430399");
      Assert.assertEquals(selectedStopArea.getParent().getObjectId(),
            "RATP_PIVI:StopArea:1234567");
   }

   @Test(groups = { "ServiceFrame" }, description = "StopArea's areaType attribute reading")
   public void verifyStopPlaceAreaType() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:StopArea:430399");
      Assert.assertEquals(selectedStopArea.getAreaType(),
            ChouetteAreaEnum.CommercialStopPoint);
   }

   @Test(groups = { "ServiceFrame" }, description = "StopArea's parent areaType attribute reading")
   public void verifyStopPlaceAreaParentAreaType() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:StopArea:1234567");
      Assert.assertEquals(selectedStopArea.getAreaType(),
   ...
   public void verifyQuayAreaType() throws XPathEvalException, NavException,
         XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:Quay:5246072");
   ...
   public void verifyStopPlaceName() throws XPathEvalException, NavException,
         XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:StopArea:430399");
   ...
   public void verifyQuayName() throws XPathEvalException, NavException,
         XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:Quay:5246072");
   ...
   public void verifyStopAreaRegistrationNumber() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:StopArea:430399");
   ...
   public void verifyStopAreaNearestTopicName() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:StopArea:430399");
   ...
   public void verifyStopAreaComment() throws XPathEvalException, NavException,
         XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:StopArea:430399");
   ...
   public void verifyStopAreaLongitude() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:Quay:5246072");
      Assert.assertEquals(selectedStopArea.getLongitude().toString(),
            "2.389129");
   }

   @Test(groups = { "ServiceFrame" }, description = "StopArea's longLatType attribute reading")
   public void verifyStopAreaLongLatType() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:Quay:5246072");
      Assert.assertEquals(selectedStopArea.getLongLatType(),
            LongLatTypeEnum.WGS84);
   }

   @Test(groups = { "ServiceFrame" }, description = "StopArea's latitude attribute reading")
   public void verifyStopAreaLatitude() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:Quay:5246072");
      Assert.assertEquals(selectedStopArea.getLatitude().toString(),
            "48.879284");
   }

   @Test(groups = { "ServiceFrame" }, description = "StopArea's projectedPoint attribute reading")
   public void verifyStopAreaProjectedPointType() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:Quay:5246072");
   ...
   public void verifyStopAreaX() throws XPathEvalException, NavException,
         XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:Quay:5246072");
   ...
   public void verifyStopAreaY() throws XPathEvalException, NavException,
         XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:Quay:5246072");
   ...
   @Test(groups = { "ServiceFrame" }, description = "StopArea's CountryCode attribute reading")
   public void verifyStopAreaPostalCode() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:Quay:5246072");
   ...
   public void verifyStopAreaStreetName() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:Quay:5246072");
   ...
   @Test(groups = { "ServiceFrame" }, description = "StopArea's X attribute reading")
   public void verifyStopPlaceX() throws XPathEvalException, NavException,
         XPathParseException, ParseException
   {
   ...
   @Test(groups = { "ServiceFrame" }, description = "StopArea's Y attribute reading")
   public void verifyStopPlaceY() throws XPathEvalException, NavException,
         XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:StopArea:430398");
   ...
   @Test(groups = { "ServiceFrame" }, description = "StopArea's CountryCode attribute reading")
   public void verifyStopPlacePostalCode() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:StopArea:430398");
      Assert.assertEquals(selectedStopArea.getCountryCode(), "75119");
   ...
   @Test(groups = { "ServiceFrame" }, description = "StopArea's streetName attribute reading")
   public void verifyStopPlaceStreetName() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:StopArea:430398");
   ...
   public void verifyRoutingConstraintType() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
   ...
   public void verifyRoutingConstraintName() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:StopArea:ITL_01");
   ...
   public void verifyRoutingConstraintComment() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:StopArea:ITL_01");
   ...
   public void verifyRoutingConstraintRegistrationNumber()
         throws XPathEvalException, NavException, XPathParseException,
         ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:StopArea:ITL_01");
   ...
   public void verifyRoutingConstraintLines() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:StopArea:ITL_01");
      Assert.assertEquals(
            selectedStopArea.getRoutingConstraintLineIds().size(), 2);
   }

   @Test(groups = { "ServiceFrame" }, description = "RoutingConstraint must have 2 area refs")
   public void verifyRoutingConstraintAreas() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      StopArea selectedStopArea = getStopAreaByObjectId("RATP_PIVI:StopArea:ITL_01");
      Assert.assertEquals(selectedStopArea.getRoutingConstraintAreas().size(),
            2);
   }
