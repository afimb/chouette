...
public class RouteTest extends ChouetteModelTest
{
   ...
   public void verifyRouteId() throws XPathExpressionException, ParseException
   {
      ...
      {
         assertXPathTrue("boolean(//netex:ServiceFrame/netex:routes/netex:Route[@id = '"
               + route.getObjectId() + "'])");
      }
   }

   @Test(groups = { "ServiceFrame", "routes" }, description = "Validate presence of Route element with expected name")
   public void verifyRouteName() throws XPathExpressionException,
         ParseException
   {
      for (Route route : line.getRoutes())
      {
         assertXPathTrue("boolean(//netex:Route[@id = '"
               + modelTranslator.netexId(route) + "']/netex:Name/text()='"
               + route.getName() + "')");
      }
   }

   @Test(groups = { "ServiceFrame", "routes" }, description = "Validate presence of PointOnRoute with expected id")
   public void verifyPointOnRouteId() throws XPathExpressionException,
         ParseException
   {
      for (Route route : line.getRoutes())
      {
   ...
   public void verifyRoutePointRefRef() throws XPathExpressionException,
         ParseException
   {
      for (Route route : line.getRoutes())
      {
   ...
   public void verifyRoutePointId() throws XPathExpressionException,
         ParseException
   {
      for (Route route : line.getRoutes())
      {
   ...
   public void verifyProjectedPointRefRef() throws XPathExpressionException,
         ParseException
   {
      for (Route route : line.getRoutes())
      {
   ...
   public void verifyScheduledStopPointId() throws XPathExpressionException,
         ParseException
   {
      for (Route route : line.getRoutes())
      {
   ...
   public void verifyRouteRefRef() throws XPathExpressionException,
         ParseException
   {
      for (Route route : line.getRoutes())
      {
   ...
   public void verifyStopPointInJourneyPatternId()
   ...
   public void verifyScheduledStopPointRefRef()
         throws XPathExpressionException, ParseException
   {
      for (Route route : line.getRoutes())
      {
         for (StopPoint stopPoint : route.getStopPoints())
         {
            String xPathExpr = "boolean(//netex:ServiceFrame/netex:servicePatterns/netex:ServicePattern/"
                  ...
                  + "[@ref = '"
                  + modelTranslator.netexId(stopPoint) + "'])";
            assertXPathTrue(xPathExpr);
   ...
   public void verifyServicePatternRef() throws XPathExpressionException,
         ParseException
   {
      for (Route route : line.getRoutes())
      {
   ...
   public void verifyVehicleJourneysScheduledStopPointRefRef()
         throws XPathExpressionException, ParseException
   {
      for (Route route : line.getRoutes())
      {
   ...
   public void verifyPassengerStopAssignmentId()
         throws XPathExpressionException, ParseException
   {
      for (Route route : line.getRoutes())
      {
   ...
   public void verifyPassengerStopAssignmentScheduledStopPointRefRef()
         throws XPathExpressionException, ParseException
   {
      for (Route route : line.getRoutes())
      {
   ...
   public void verifyPassengerStopAssignmentQuayRefRef()
         throws XPathExpressionException, ParseException
   {
      for (Route route : line.getRoutes())
      {
         for (StopPoint stopPoint : route.getStopPoints())
         {
            String xPathExpr = "boolean(//netex:ServiceFrame/netex:stopAssignments/"
                  ...
                  + "[@ref = '"
                  + modelTranslator.netexId(stopPoint.getContainedInStopArea())
                  + "'])";
