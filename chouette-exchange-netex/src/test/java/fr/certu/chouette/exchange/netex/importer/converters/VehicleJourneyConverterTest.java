...
public class VehicleJourneyConverterTest extends
      AbstractTestNGSpringContextTests
{
   ...
   private VehicleJourney getByObjectId(String objectId)
         ...
         ParseException
   {
      ...
      Assert.assertNotNull(selectedVehicle,
            "can't find expected vehicle having " + objectId + " as objectId");
      return selectedVehicle;
   }

   @Test(groups = { "TimeTableFrame" }, description = "VehicleJourney's PublishedJourneyName attribute reading")
   public void verifyPublishedJourneyName() throws XPathEvalException,
   ...
   public void verifyPublishedJourneyIdentifier() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      VehicleJourney selectedVehicle = getByObjectId("T:VehicleJourney:1-0-1-0");
      Assert.assertEquals(selectedVehicle.getPublishedJourneyIdentifier(),
            "short 0");
   }
