...
public class JourneyPatternConverterTests extends
      AbstractTestNGSpringContextTests
{
   ...
   public void verifyJourneyPatternConverter() throws XPathEvalException,
         NavException, XPathParseException, ParseException
   {
      ...
      while (autoPilot.evalXPath() != -1)
      {
         ...
         Assert.assertEquals(nav.toNormalizedString(position), journeyPatterns
               .get(counter).getName());
         counter++;
      }
