...
public class VehicleJourneyTest extends ChouetteModelTest
{
   ...
   public void verifyPublishedJourneyName() throws XPathExpressionException,
         ParseException
   {
      ...
      for (VehicleJourney vehicleJourney : vehicleJourneys)
      {
         String xPathExpr = "boolean(//netex:TimetableFrame/netex:vehicleJourneys/"
               ...
               + "netex:Name/"
               + "text() = '"
               + vehicleJourney.getPublishedJourneyName() + "')";
         assertXPathTrue(xPathExpr);
      }
   }
   ...
   public void verifyPublishedJourneyIdentifier()
   ...
   public void verifyRouteRef() throws XPathExpressionException, ParseException
   {
      ...
      for (VehicleJourney vehicleJourney : vehicleJourneys)
      {
         String xPathExpr = "boolean(//netex:TimetableFrame/netex:vehicleJourneys/"
               ...
               + "']/"
               + "netex:RouteRef[ @ref = '"
               + modelTranslator.netexId(vehicleJourney.getRoute()) + "'])";
         assertXPathTrue(xPathExpr);
      }
   }
         ...
         ParseException
   {
      ...
      for (VehicleJourney vehicleJourney : vehicleJourneys)
      {
         String xPathExpr = "boolean(//netex:TimetableFrame/netex:vehicleJourneys/"
               ...
               + modelTranslator.netexId(vehicleJourney)
               + "']/"
               + "netex:ServicePatternRef[ @ref = '"
               + modelTranslator.netexId(vehicleJourney.getJourneyPattern())
               + "'])";
         assertXPathTrue(xPathExpr);
      }
   }
   ...
   public void verifyOperatorRef() throws XPathExpressionException,
         ParseException
   {
      ...
      for (VehicleJourney vehicleJourney : vehicleJourneys)
      {
         String xPathExpr = "boolean(//netex:TimetableFrame/netex:vehicleJourneys/"
               ...
               + modelTranslator.netexId(vehicleJourney)
               + "']/"
               + "netex:OperatorRef[ @ref = '"
               + modelTranslator.netexId(vehicleJourney.getCompany()) + "'])";
         assertXPathTrue(xPathExpr);
      }
   }

   @Test(groups = { "TimetableFrame", "vehicleJourneys" }, description = "Validate presence of ServiceJourney with expected trainNumber")
   public void verifyTrainNumberRef() throws XPathExpressionException,
         ParseException
   {
      ...
      for (VehicleJourney vehicleJourney : vehicleJourneys)
      {
         String xPathExpr = "boolean(//netex:TimetableFrame/netex:vehicleJourneys/"
               ...
               + "']/"
               + "netex:trainNumbers/"
               + "netex:TrainNumberRef[ @ref = '"
               + modelTranslator.trainNumberId(vehicleJourney.getNumber())
               + "'])";
         assertXPathTrue(xPathExpr);
      }
   }
   ...
   public void verifyTrainNumbers() throws XPathExpressionException,
         ParseException
   {
      ...
      for (VehicleJourney vehicleJourney : vehicleJourneys)
      {
         String xPathExpr = "boolean(//netex:TimetableFrame/"
               + "netex:trainNumbers/" + "netex:TrainNumber[ @id = '"
               + modelTranslator.trainNumberId(vehicleJourney.getNumber())
               + "'])";
         assertXPathTrue(xPathExpr);
      }
   ...
   public void verifyDayTypeRef() throws XPathExpressionException,
         ParseException
   {
