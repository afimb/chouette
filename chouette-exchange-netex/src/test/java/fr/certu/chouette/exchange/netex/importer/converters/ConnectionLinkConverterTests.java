...
public class ConnectionLinkConverterTests
{
   ...
   private ConnectionLink getConnectionLinkByObjectId(String objectId)
         ...
         XPathParseException, ParseException
   {
      ...
      Assert.assertEquals(selectedLink.getLinkType(),
            ConnectionLinkTypeEnum.Overground);
   }
   ...
   public void verifyStartRef() throws XPathEvalException, NavException,
         XPathParseException, ParseException
   {
      ConnectionLink selectedLink = getConnectionLinkByObjectId("RATP_PIVI:SiteConnection:1357");
      Assert.assertEquals(selectedLink.getEndOfLinkId(),
            "RATP_PIVI:Quay:5246067");
   }
   ...
   public void verifyEndRef() throws XPathEvalException, NavException,
         XPathParseException, ParseException
   {
      ConnectionLink selectedLink = getConnectionLinkByObjectId("RATP_PIVI:SiteConnection:1357");
      Assert.assertEquals(selectedLink.getStartOfLinkId(),
            "RATP_PIVI:Quay:5246070");
   }
