...
public class ConnectionLinkTest extends ChouetteModelTest
{
   ...
   public void verifyConnectionLink() throws XPathExpressionException,
         ParseException
   {
   ...
   public void verifyLinkDistance() throws XPathExpressionException,
         ParseException
   {
      List<ConnectionLink> connectionLinks = line.getConnectionLinks();
   ...
   public void verifyLinkType() throws XPathExpressionException, ParseException
   {
      ...
      for (ConnectionLink connectionLink : connectionLinks)
      {
         assertXPathTrue("boolean(" + xPathRoot + "/netex:SiteConnection"
               ...
               + "/netex:Covered/text()='"
               + modelTranslator.toLinkType(connectionLink.getLinkType())
               + "')");
      }
   }
         ...
         ParseException
   {
      ...
      for (ConnectionLink connectionLink : connectionLinks)
      {
         assertXPathTrue("boolean("
               ...
               + "/netex:DefaultDuration/text()='"
               + durationFactory.newDuration(connectionLink
                     .getDefaultDuration().getTime()) + "')");
      }
   }
         ...
         throws XPathExpressionException, ParseException
   {
      ...
      for (ConnectionLink connectionLink : connectionLinks)
      {
         assertXPathTrue("boolean("
               ...
               + "']"
               + "/netex:TransferDuration"
               + "/netex:FrequentTravellerDuration/text()='"
               + durationFactory.newDuration(connectionLink
   ...
   public void verifyConnectionLinkStartAndEnd()
         throws XPathExpressionException, ParseException
   {
      List<ConnectionLink> connectionLinks = line.getConnectionLinks();
      ...
      for (ConnectionLink connectionLink : connectionLinks)
      {
         assertXPathTrue("boolean(//netex:SiteConnection[@id = '"
               + getId(connectionLink)
               + "']/netex:From/netex:StopPlaceRef/@ref='"
               + modelTranslator.netexId(connectionLink.getStartOfLink())
               + "')");

         assertXPathTrue("boolean(//netex:SiteConnection[@id = '"
               + getId(connectionLink)
               + "']/netex:To/netex:StopPlaceRef/@ref='"
               + modelTranslator.netexId(connectionLink.getEndOfLink()) + "')");
      }
