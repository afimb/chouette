      ...
      AbstractModelProducer<PTNetwork, PTNetworkType>
{
   ...
   @Override
   public PTNetwork produce(String sourceFile, PTNetworkType xmlPTNetwork,
         ...
         SharedImportedData sharedData, UnsharedImportedData unshareableData)
   {
      ...
      ptNetwork.setRegistrationNumber(getRegistrationNumber(
            xmlPTNetwork.getRegistration(), importReport));
      ...
      PTNetwork sharedBean = getOrAddSharedData(sharedData, ptNetwork,
            sourceFile, xmlPTNetwork, validationReport);
      if (sharedBean != null)
