...
public class XMLNeptuneExportLinePlugin implements IExportPlugin<Line>
{
	...
	public void doExport(List<Line> beans, List<ParameterValue> parameters, ReportHolder reportContainer)
		...
		if (fileExtension.equals("xml"))
		{
			try {
				...
				report.addItem(item);
				JAXBElement<ChouettePTNetworkType> rootObject = exportLine(line,startDate,endDate,item);
				if (rootObject != null)
				{    
	 ...
	 */
	private JAXBElement<ChouettePTNetworkType> exportLine(Line line, Date startDate, Date endDate, ReportItem report)
	{
