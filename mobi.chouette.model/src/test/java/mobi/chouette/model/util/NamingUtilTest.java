...
//		object.getChouetteId().setObjectId("test:Network:1");
		...
		object.setChouetteId(new ChouetteId("test", "1", false));
		object.setName("test");
		Assert.assertEquals(NamingUtil.getName(object),object.getName(),"name should be returned");
		object.setName("");
		Assert.assertEquals(NamingUtil.getName(object),object.getChouetteId().toString(),"objectId should be returned");
		object.setName(null);
		Assert.assertEquals(NamingUtil.getName(object),object.getChouetteId().toString(),"objectId should be returned");
	}
