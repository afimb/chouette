...
public abstract class AbstractBasicManagerTests<T extends NeptuneIdentifiedObject>
      extends AbstractManagerTests<T>
{
   ...
   public void verifyGetNewInstance() throws ChouetteException
   {
      ...
      Assert.assertTrue(retbean.getClass().equals(bean.getClass()),
            "bean should be instance of " + beanName);
   }
