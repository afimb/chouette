...
public abstract class AbstractNoDaoManagerTests<T extends NeptuneIdentifiedObject>
      extends AbstractManagerTests<T>
{
   ...
   {
      // manager.setDao(null);
      Map<String, AbstractNeptuneManager> managers = applicationContext
            .getBeansOfType(AbstractNeptuneManager.class);
