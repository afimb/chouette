...
{
   /**
    * compute coordinates for parents StopAreas with barycentre of
    * containedStopAreas<br/>
    * 
   ...
   /**
    * convert projectedPoint Lambert2e coordinates in WGS84 ones for every empty
    * WGS84 data
    */
   void convertToWGS84();

   /**
    * convert WGS84 coordinates in projectedPoint Lambert2e ones for every empty
    * projected points
    */
