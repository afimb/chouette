...
/**
 * interface for database access tool <br/>
 * a CRUD oriented database access must implement every methods except purge <br/>
 * a mass oriented database access must implement purge, saveOrUpdateAll and
 * getAll
 * 
 * @author michel
 * 
 * @param <T>
 *           NeptuneObject to access
 */
public interface IDaoTemplate<T extends NeptuneObject>
{
    ...
    * 
    * @param clause
    *           clause for objects to be deleted
    * @return
    */
    ...
    * 
    * @param clause
    *           clause for objects to be returned
    * @return
    */
    ...
    * 
    * @param objects
    *           objects to be saved or updates
    */
