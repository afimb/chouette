...
public class DbVehicleJourney extends
      fr.certu.chouette.model.neptune.VehicleJourney
{
    ...
    * 
    * @see
    * fr.certu.chouette.model.neptune.VehicleJourney#addVehicleJourneyAtStop
    * (fr.certu.chouette.model.neptune.VehicleJourneyAtStop)
    */
   @Override
   ...
   public void purgeVehicleJourneyAtStops()
   {
      if (buffer != null)
      {
         factory.releaseVehiclejourneyAtStops(buffer);
         buffer.clear();
      }
   }
    ...
    * 
    * @see
    * fr.certu.chouette.model.neptune.VehicleJourney#addVehicleJourneyAtStops
    ...
    * 
    * @see
    * fr.certu.chouette.model.neptune.VehicleJourney#removeStopPoint(fr.certu
    * .chouette.model.neptune.StopPoint)
    */
   @Override
    ...
    * 
    * @see
    * fr.certu.chouette.model.neptune.VehicleJourney#sortVehicleJourneyAtStops
    * ()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see fr.certu.chouette.model.neptune.VehicleJourney#complete()
    */
   @Override
   public void complete()
   {
      ...
      setStartOfPeriod(null);
      setEndOfPeriod(null);
      for (Timetable timetable : getTimetables())
      {
         timetable.complete();
         setStartOfPeriod(minDate(timetable.getStartOfPeriod(),
               getStartOfPeriod()));
         setEndOfPeriod(maxDate(timetable.getEndOfPeriod(), getEndOfPeriod()));
      }
   }
