...
public class PluginInjector<T extends NeptuneIdentifiedObject>
{
   ...
   @Getter
   @Setter
   private INeptuneManager<T> manager;
   @Getter
   @Setter
   private List<IImportPlugin<T>> importPlugins;
   @Getter
   @Setter
   private List<IExportPlugin<T>> exportPlugins;
   @Getter
   @Setter
   private List<IExportPlugin<T>> exportDeletionPlugins;
   @Getter
   @Setter
   private List<ICheckPointPlugin<T>> checkPointPlugins;
