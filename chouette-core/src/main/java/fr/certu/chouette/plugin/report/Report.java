...
public abstract class Report
{
   ...
   public void addItem(ReportItem item)
   {
      ...
      {
         if (it.getMessageKey() != null
               && it.getMessageKey().equals(messageKey))
         {
    ...
    */
   public static void print(PrintStream stream, Report report,
         boolean closeOnExit)
   {
    ...
    *           items to print
    */
   private static void printItems(PrintStream stream, String indent,
