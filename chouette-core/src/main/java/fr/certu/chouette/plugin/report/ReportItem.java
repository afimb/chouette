 ...
 * 
 */
public abstract class ReportItem extends Report implements
      Comparable<ReportItem>
{
   ...
   @Getter
   @Setter
   private List<Object> messageArgs = new ArrayList<Object>();
   @Getter
   @Setter
   private int order;
   ...
   public JSONObject toJSON()
   {
      ...
      // {
      //
      // builder.append(subitems.get(i).toJSON(indent+"    ",i ==
      // subitems.size()-1));
      // }
      // builder.append(indent+"  ]\n");
      // }
