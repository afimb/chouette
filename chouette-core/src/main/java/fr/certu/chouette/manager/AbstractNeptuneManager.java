 ...
 * @param <T>
 */
public abstract class AbstractNeptuneManager<T extends NeptuneIdentifiedObject>
      implements INeptuneManager<T>
{
   private static final Logger localLogger = Logger
         .getLogger(AbstractNeptuneManager.class);
   ...
   @Getter
   @Setter
   private IDaoTemplate<T> jdbcDao;

   @Getter
   @Setter
   private String objectIdDefaultPrefix;
   ...
   public T getNewInstance(User user) throws ChouetteException
   {
      try
      {
         return (T) neptuneType.getConstructor(new Class[0]).newInstance(
               new Object[0]);
      } catch (Exception e)
      {
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#setObjectId(fr.certu.chouette
    * .model.user.User, fr.certu.chouette.model.neptune.NeptuneIdentifiedObject,
    * java.lang.String)
    */
   @Override
   public void setObjectId(User user, T bean, String prefix)
         throws ChouetteException
   {
      if (bean.getId() == null)
         return;
      String objectId = (prefix == null ? objectIdDefaultPrefix : prefix) + ":"
            + objectIdKey + ":" + bean.getId().toString();
    ...
    * @return
    */
   public static INeptuneManager<? extends NeptuneIdentifiedObject> getManager(
         Class<? extends NeptuneIdentifiedObject> neptuneType)
   {
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#addImportPlugin(fr.certu.chouette
    * .plugin.exchange.IImportPlugin)
    */
   @Override
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#addExportPlugin(fr.certu.chouette
    * .plugin.exchange.IExportPlugin)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see fr.certu.chouette.manager.INeptuneManager#addExportDeletionPlugin(fr.
    * certu .chouette.plugin.exchange.IExportPlugin)
    */
   @Override
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#addValidationPlugin(fr.certu
    * .chouette.plugin.validation.IValidationPlugin)
    */
   @Override
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#addNew(fr.certu.chouette.model
    * .user.User, fr.certu.chouette.model.neptune.NeptuneObject)
    */
   @Transactional
   @Override
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#exists(fr.certu.chouette.model
    * .user.User, fr.certu.chouette.model.neptune.NeptuneObject)
    */
   @Transactional
   @Override
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#get(fr.certu.chouette.model.
    * user.User, fr.certu.chouette.filter.Filter,
    * fr.certu.chouette.filter.DetailLevelEnum)
    */
   @Transactional
   @Override
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#getAll(fr.certu.chouette.model
    * .user.User, fr.certu.chouette.filter.Filter,
    * fr.certu.chouette.filter.DetailLevelEnum)
    */
   @Transactional
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#count(fr.certu.chouette.model
    * .user.User, fr.certu.chouette.filter.Filter)
    */
   @Override
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#purge(fr.certu.chouette.model
    * .user.User, boolean)
    */
   @Override
    ...
    * 
    * @see
    * fr.certu.chouette.manager.NeptuneBeanManager#update(fr.certu.chouette.
    * model.user.User, fr.certu.chouette.model.neptune.NeptuneBean)
    */
   @Transactional
   @Override
    ...
    * 
    * @see
    * fr.certu.chouette.manager.NeptuneBeanManager#isRemovable(fr.certu.chouette
    * .model.user.User, fr.certu.chouette.model.neptune.NeptuneBean)
    */
   @Transactional
   @Override
    ...
    * 
    * @see
    * fr.certu.chouette.manager.NeptuneBeanManager#remove(fr.certu.chouette.
    * model.user.User, fr.certu.chouette.model.neptune.NeptuneBean)
    */
   @Transactional
   @Override
   public void remove(User user, T bean, boolean propagate)
         throws ChouetteException
   {
      if (getDao() == null)
         throw new CoreException(CoreExceptionCode.NO_DAO_AVAILABLE,
    ...
    * 
    * @see
    * fr.certu.chouette.manager.NeptuneBeanManager#removeAll(fr.certu.chouette
    * .model.user.User, fr.certu.chouette.manager.Filter)
    */
   @Transactional
   @Override
   public void removeAll(User user, List<T> objects, boolean propagate)
         throws ChouetteException
   {
      if (getDao() == null)
         throw new CoreException(CoreExceptionCode.NO_DAO_AVAILABLE,
               "unavailable resource");
      /*
       * for (T t : objects) { remove(user, t, propagate); }
       */
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#getImportFormats(fr.certu.chouette
    * .model.user.User)
    */
   @Override
   ...
   @Override
   public List<T> doImport(User user, String formatDescriptor,
         List<ParameterValue> parameters, ReportHolder importReport,
         ReportHolder validationReport) throws ChouetteException
   {
      IImportPlugin<T> plugin = importPluginMap.get(formatDescriptor);
      if (plugin == null)
         throw new CoreException(CoreExceptionCode.NO_PLUGIN_AVAILABLE,
               "unknown format :" + formatDescriptor);
   ...
   @Transactional
   @Override
   public void save(User user, T object, boolean propagate)
         throws ChouetteException
   {
      if (getDao() == null)
         throw new CoreException(CoreExceptionCode.NO_DAO_AVAILABLE,
      ...
      if (object.getId() == null)
      {
         ...
         if (object.getObjectId() == null || object.getObjectId().isEmpty())
            object.setObjectId("::pending_Id::" + random.nextLong()); // mandatory
         // in
         // database
         getDao().save(object);
      }
      if (object.getObjectId() == null || object.getObjectId().isEmpty()
            || object.getObjectId().startsWith("::pending_Id::"))
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#saveAll(fr.certu.chouette.model
    * .user.User, java.util.List)
    */
   // @Override
   // public final void saveAll(User user, List<T> beans,boolean propagate)
   // throws ChouetteException
   // {
   //
   // // if(getJdbcDao() == null)
   // // throw new CoreException(CoreExceptionCode.NO_JDBC_DAO_AVAILABLE,
   // "unavailable resource");
   // //
   ...
   @Transactional
   @Override
   public void saveAll(User user, List<T> beans, boolean propagate, boolean fast)
         throws ChouetteException
   {
      ...
      } else
      {
         if (getDao() == null)
            throw new CoreException(CoreExceptionCode.NO_DAO_AVAILABLE,
                  "unavailable resource");
         getLogger().debug(
               "saving " + beans.size() + " " + neptuneType.getSimpleName());
    ...
    * 
    * @see
    * fr.certu.chouette.manager.NeptuneBeanManager#saveOrUpdateAll(fr.certu.
    * chouette.model.user.User, java.util.List)
    */
   @Transactional
   @Override
   public void saveOrUpdateAll(User user, List<T> beans)
         throws ChouetteException
   {
      if (getDao() == null)
         throw new CoreException(CoreExceptionCode.NO_DAO_AVAILABLE,
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#getExportFormats(fr.certu.chouette
    * .model.user.User)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see fr.certu.chouette.manager.INeptuneManager#doExport(fr.certu.chouette.
    * model .user.User, java.util.List, java.lang.String, java.util.List,
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#doExportFromDatabase(fr.certu
    * .chouette.model.user.User, java.util.List, java.lang.String,
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#getDeleteExportFormats(fr.certu
    * .chouette.model.user.User)
    */
   @Override
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#doExportDeleted(fr.certu.chouette
    * .model.user.User, java.util.List, java.lang.String, java.util.List,
    * fr.certu.chouette.plugin.report.ReportHolder)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see fr.certu.chouette.manager.INeptuneManager#validate(fr.certu.chouette.
    * model .user.User, java.util.List,
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#getValidationSteps(fr.certu.
    * chouette.model.user.User)
    */
   // @Override
    ...
    * 
    * @see
    * fr.certu.chouette.manager.INeptuneManager#validateStep(fr.certu.chouette
    * .model.user.User, java.util.List, java.lang.String,
    * fr.certu.chouette.plugin.validation.ValidationParameters)
    */
   // @Override
   // public ReportItem validateStep(User user, List<T> beans, String
   // stepDescriptor, ValidationParameters parameters)
   // throws ChouetteException
   // {
   //
   // return null;
    ...
    *           objects to add
    */
   protected static <U> void mergeCollection(Collection<U> target,
         Collection<U> source)
   {
   ...
   /**
    * add source in target collection if not null, not already in database and
    * not already in target
    * 
    * @param <U>
    *           type of source and collection entries
    * @param target
    *           collection
    * @param source
    *           object to add
    */
   protected static <U extends NeptuneIdentifiedObject> void addIfMissingInCollection(
         Collection<U> target, U source)
   {
      if (source == null)
         return;
      if (source.getId() != null)
      {
         localLogger.debug(source.getObjectId()
               + " not added , already saved as " + source.getId());
         return;
      }
    ...
    * 
    * @param <U>
    *           type of collection entries
    * @param beans
    *           collection
    * @return
    */
   protected static <U extends NeptuneIdentifiedObject> List<Long> getIds(
         Collection<U> beans)
   {
