...
public interface INeptuneManager<T extends NeptuneIdentifiedObject>
{
    ...
    * 
    * @param dao
    *           an IDaoTemplate implementation
    */
    ...
    * 
    * @param user
    *           user account for security check
    ...
    *           the bean to update
    * @param prefix
    *           prefix for object id (null for default value)
    * 
    * @throws ChouetteException
    */
    ...
    *           user account for security check
    * @param bean
    *           the bean to insert and its dependencies
    * @return the bean inserted (may be updated with technical informations)
    * @throws ChouetteException
    *            invalid user access or potentially newly beans exist or break
    ...
    * if multiple unique constraints matched, true will be returned, even if
    * different objects match these constraints
    * 
    * @param user
    *           user account for security check
    * @param bean
    ...
    * if more than one beans are eligible for the criteria, an Exception is
    * thrown
    * 
    * @param user
    *           user account for security check
    ...
    * @throws ChouetteException
    *            invalid user access or not unicity criteria
    */
    ...
    * @throws ChouetteException
    *            invalid user access or storage access problem
    */
    ...
    * the bean may contain dependencies with new beans, in this case, the new
    * beans will be added<br/>
    ...
    *           the bean to update
    * @throws ChouetteException
    *            invalid user access or constraints conflits or storage access
    *            problem
    */
    ...
    *           the bean to delete
    * @throws ChouetteException
    *            invalid user access or constraints conflicts or storage access
    *            problem
    */
    ...
    * @throws ChouetteException
    */
   void removeAll(User user, List<T> objects, boolean propagate)
         throws ChouetteException;
    ...
    *           name of the format found in ImportFormatDescription structure
    * @param parameters
    *           import parameter according to specified format
    * @param importReport
    *           import reporting container
    * @param validationReport
    *           validation reporting container
    * @return a collection of imported beans (with all imported dependencies)
    * @throws ChouetteException
    *            invalid user access or import failure
    */
   List<T> doImport(User user, String formatDescriptor,
    ...
    *           user account for security check
    * @param beans
    *           a collection of beans to save
    * @param propagate
    *           indicate if sub objects should be saved automatically
    * @throws ChouetteException
    *            invalid user access or constraints conflits or storage access
    *            problem
    */
   // void saveAll(User user, List<T> beans,boolean propagate) throws
   // ChouetteException;
    ...
    * new dependencies will be added but when multiple dependency is allowed,
    * old dependencies wont be deleted
    * 
    * @param user
    *           user account for security check
    * @param beans
    ...
    *           beans to export
    * @param formatDescriptor
    *           name of the format found in ExportFormatDescription structure
    * @param parameters
    *           export parameter according to specified format
    * @param report
    *           export reporting container
    * @throws ChouetteException
    *            invalid user access or export failure
    */
   void doExport(User user, List<T> beans, String formatDescriptor,
    ...
    *            invalid user access or export failure
    */
   void doExportFromDatabase(User user, List<Long> beanIds,
    ...
    *            invalid user access
    */
   List<FormatDescription> getDeleteExportFormats(User user)
         throws ChouetteException;
    ...
    *            invalid user access or export failure
    */
   void doExportDeleted(User user, List<T> beans, String formatDescriptor,
         List<ParameterValue> parameters, ReportHolder report)
         throws ChouetteException;
    ...
    *            invalid user access
    */
   // List<ValidationStepDescription> getValidationSteps(User user) throws
   // ChouetteException;
    ...
    *            invalid user access or export failure
    */
   // ReportItem validateStep(User user, List<T> beans, String
   // stepDescriptor,ValidationParameters parameters) throws ChouetteException;
    ...
    * Complete this object by setting all shortcutIds and objects required (in
    * export process for example)
    * 
    * @param user
    * @param bean
    * @throws ChouetteException
    ...
    *           a collection of beans to save
    * @param propagate
    *           indicates if sub objects should be saved automatically
    * @param fast
    *           indicates if you want to save quickly
    * @throws ChouetteException
    *            invalid user access or constraints conflits or storage access
    *            problem
    */
