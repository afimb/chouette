...
public class VehicleJourneyJdbcDao extends AbstractJdbcDao<VehicleJourney>
{
   private static final Logger logger = Logger
         .getLogger(VehicleJourneyJdbcDao.class);
   ...
   protected void populateStatement(PreparedStatement ps,
         VehicleJourney vehicleJourney) throws SQLException
   {
         ...
         PreparedStatement ps, Object attribute) throws SQLException
   {
      if (attributeKey.equals("vjAtStop"))
      {
         ...
         if (vAtStop.getBoardingAlightingPossibility() != null)
            bordingPossibility = vAtStop.getBoardingAlightingPossibility()
                  .name();
         ps.setString(4, bordingPossibility);
         Time arrivaltime = null, departuretime = null, waitingtime = null, elapseduration = null, headwayfrequency = null;
   ...
   protected Collection<? extends Object> getAttributeValues(
         String attributeKey, VehicleJourney item)
   {
      if (attributeKey.equals("vjAtStop"))
      {
   ...
   {
      Long timetableid, vehiclejourneyid;
   }
