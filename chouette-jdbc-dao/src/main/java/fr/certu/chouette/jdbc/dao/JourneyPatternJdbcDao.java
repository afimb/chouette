...
public class JourneyPatternJdbcDao extends AbstractJdbcDao<JourneyPattern>
{
   private static final Logger logger = Logger
         .getLogger(JourneyPatternJdbcDao.class);
   ...
   protected void populateStatement(PreparedStatement ps,
         JourneyPattern journeyPattern) throws SQLException
   {
      ...
      setId(ps, 10, journeyPattern.getDepartureStopPoint(), true,
            "departure_stop_point_id");
      setId(ps, 11, journeyPattern.getArrivalStopPoint(), true,
            "arrival_stop_point_id");
   }

   @Override
   protected Collection<? extends Object> getAttributeValues(
         String attributeKey, JourneyPattern item)
   {
