...
public class ConnectionLinkJdbcDao extends AbstractJdbcDao<ConnectionLink>
{
   private static final Logger logger = Logger
         .getLogger(ConnectionLinkJdbcDao.class);
   ...
   protected void populateStatement(PreparedStatement ps,
         ConnectionLink connectionLink) throws SQLException
   {
      ...
      setId(ps, 8, connectionLink.getStartOfLink(), true, "departure_id");
      setId(ps, 9, connectionLink.getEndOfLink(), true, "arrival_id");
      ...
      Time defaultduration = null, frequenttravellerduration = null, occasionaltravellerduration = null, mobilityrestrictedtravellerduration = null;

      if (connectionLink.getDefaultDuration() != null)
         defaultduration = new Time(connectionLink.getDefaultDuration()
               .getTime());

      if (connectionLink.getFrequentTravellerDuration() != null)
         frequenttravellerduration = new Time(connectionLink
               .getFrequentTravellerDuration().getTime());

      if (connectionLink.getOccasionalTravellerDuration() != null)
         occasionaltravellerduration = new Time(connectionLink
               .getOccasionalTravellerDuration().getTime());

      if (connectionLink.getMobilityRestrictedTravellerDuration() != null)
         mobilityrestrictedtravellerduration = new Time(connectionLink
