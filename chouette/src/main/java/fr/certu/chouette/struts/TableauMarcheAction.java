...
public class TableauMarcheAction extends GeneriqueAction implements Preparable, ModelDriven<TableauMarche>
{
  ...
  {
    TableauMarcheAction.reseauManager = reseauManager;
  }
