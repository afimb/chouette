...
import fr.certu.chouette.ihm.enumeration.ObjetEnumere;
...
public class CorrespondanceAction extends GeneriqueAction implements Preparable, RequestAware {
	...
	public String searchResults() {
		...
		if (criteria.getAreaType() != null)
			...
			List <ObjetEnumere> areaEnumerations = fr.certu.chouette.ihm.enumeration.EnumerationApplication.getArretPhysiqueAreaTypeEnum();
			areaEnumerations.addAll(fr.certu.chouette.ihm.enumeration.EnumerationApplication.getZoneAreaTypeEnum());
