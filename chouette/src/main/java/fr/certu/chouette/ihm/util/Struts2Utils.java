package fr.certu.chouette.ihm.util;
...
public final class Struts2Utils {
	...
	private static final String CHOUETTE_IHM_PACKAGE_NAME = "fr.certu.chouette.ihm.";
	...
	public static String getModelClassFullNameFromUrl (final String url) throws Exception {
        ...
        String modelClassPackageName = CHOUETTE_IHM_PACKAGE_NAME + actionClassName.toLowerCase();
