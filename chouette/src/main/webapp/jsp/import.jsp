...
<s:url id="urlImports" action="Import_execute" namespace="/" includeParams="none"/>
...
<div>
	...
	<FIELDSET align="center" style="width: 500px;"> 
		...
		<s:form id="uploadCSVForm" action="Import_importCSV" namespace="/" enctype="multipart/form-data" method="POST">
	...
	<FIELDSET align="center" style="width: 500px;"> 
	   <LEGEND><b>Import au format XML</b></LEGEND> 
		<s:form id="uploadXMLForm" action="Import_importXML" namespace="/" enctype="multipart/form-data" method="POST">
		   <s:file name="fichier" label="%{getText('action.browse')}" />
	...
	<FIELDSET align="center" style="width: 500px;"> 
	   <LEGEND><b>Import multilignes au format XML</b></LEGEND> 
		<s:form id="uploadXMLForm" action="Import_importXMLs" namespace="/" enctype="multipart/form-data" method="POST">
		   <s:file name="fichier" label="%{getText('action.browse')}" />
		   <s:hidden name="fichierContentType" value="text/xml; charset=UTF-8"/>
	...
	<FIELDSET align="center" style="width: 500px;"> 
		...
		<s:form id="uploadAltibusForm" action="Import_importAltibus" namespace="/" enctype="multipart/form-data" method="POST">
		     <!--s:file name="fichier" label="%{getText('action.browse')}"/-->
		     <!--s:hidden name="fichierContentType" value="text/csv; charset=UTF-8"/-->
	...
	<FIELDSET align="center" style="width: 500px;"> 
	   <LEGEND><b>Import au format CSV Multi Lignes</b></LEGEND> 
		<s:form id="uploadCSVGenericForm" action="Import_importCSVGeneric" namespace="/" enctype="multipart/form-data" method="POST">
		   <s:file name="fichier" label="%{getText('action.browse')}" />
		   <s:hidden name="fichierContentType" value="text/xml; charset=UTF-8"/>
	...
	<FIELDSET align="center" style="width: 500px;"> 
	   <LEGEND><b>Import au format XML STIF</b></LEGEND> 
		<s:form id="uploadAMIVIFForm" action="Import_importAmivifXML" namespace="/" enctype="multipart/form-data" method="POST">
		   <s:file name="fichier" label="%{getText('action.browse')}" />
		   <s:hidden name="fichierContentType" value="text/xml; charset=UTF-8"/>
	...
	<FIELDSET align="center" style="width: 500px;"> 
		...
		<s:form id="uploadPegaseForm" action="Import_importPegase" namespace="/" enctype="multipart/form-data" method="POST">
		     <s:file name="fichier" label="%{getText('action.browse')}"/>
		     <s:hidden name="fichierContentType" value="text/csv; charset=UTF-8"/>
