		...
		<s:iterator value="itineraires" id="itineraire" status="rangItineraire">
			...
			<s:else>
				...
				<TD class="${cssBordure}">
			    	...
			    	<s:a href="%{removeUrl}" onclick="return confirm('%{getText('itineraire.delete.confirmation')}');"><img border="0" src="images/supprimer.png" title="<s:text name="tooltip.delete"/>"></s:a> 	
			    </TD>	
				<TD class="${cssBordure}">
