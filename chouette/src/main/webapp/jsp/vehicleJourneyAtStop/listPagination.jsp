...
<table id="pagination" style="font-stretch:wider">
	<thead>
		<tr>
	...
	<tbody>
		<tr>
			<td>
				<s:url id="pagePrecedente" action="liste_HorairesDePassage">
			...
			<s:iterator value="pagination.pages" status="rangPage" id="page">
				<td>
					<s:url id="pageIterateur" action="liste_HorairesDePassage">
						<s:param name="seuilDateDepartCourse">
							<s:if test="seuilDateDepartCourse != null">
								<s:date name="seuilDateDepartCourse" format="HH:mm"/>
							</s:if>
			...
			<td>
				<s:url id="pageSuivante" action="liste_HorairesDePassage">
					<s:param name="seuilDateDepartCourse">
						<s:if test="seuilDateDepartCourse != null">
							<s:date name="seuilDateDepartCourse" format="HH:mm"/>
						</s:if>
