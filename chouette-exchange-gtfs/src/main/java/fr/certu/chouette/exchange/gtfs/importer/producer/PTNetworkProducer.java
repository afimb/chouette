...
public class PTNetworkProducer extends
      AbstractModelProducer<PTNetwork, GtfsNetwork>
{
    ...
    * 
    * @see
    * fr.certu.chouette.exchange.gtfs.importer.producer.IModelProducer#produce
    * (java.lang.String, fr.certu.chouette.exchange.gtfs.model.GtfsBean,
    * fr.certu.chouette.plugin.report.ReportItem)
    */
   @Override
   public PTNetwork produce(GtfsNetwork gtfsNetwork, Report report)
   {
      ...
      ptNetwork.setObjectId(composeObjectId(PTNetwork.PTNETWORK_KEY,
            getPrefix(), logger));
