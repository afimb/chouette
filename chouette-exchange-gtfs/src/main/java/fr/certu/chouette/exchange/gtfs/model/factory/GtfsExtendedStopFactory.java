...
public class GtfsExtendedStopFactory extends GtfsBeanFactory<GtfsExtendedStop> 
{
	...
	private static final Logger logger = Logger.getLogger(GtfsExtendedStopFactory.class);
	@Getter private final String dropSql = "drop table if exists stop;";
	@Getter private final String createSql = "create table stop (num, id, code,name,desc,lat,lon,zoneid,url,locationtype,parentstation,addressline,locality,postalcode);";
	...
	@Getter private final String selectSql = "select num, id, code,name,desc,lat,lon,zoneid,url,locationtype,parentstation,addressline,locality,postalcode from stop ";
	@Getter private final String[] dbHeader = new String[]{"num","stop_id","stop_code","stop_name","stop_desc","stop_lat","stop_lon","zone_id","stop_url","location_type","parent_station","address_line","locality","postal_code"};
	...
	@Override
	public GtfsExtendedStop getNewGtfsBean(int lineNumber, String[] csvLine,Report report) {
