...
public class ModelAssembler
{
   ...
   // private Map<String, Route> routesDictionary = new HashMap<String,
   // Route>();
   // private Map<String, JourneyPattern> journeyPatternsDictionary = new
   // HashMap<String, JourneyPattern>();
   // private Map<String, VehicleJourney> vehicleJourneysDictionary = new
   // HashMap<String, VehicleJourney>();
   // private Map<String, StopPoint> stopPointsDictionary = new HashMap<String,
   // StopPoint>();
   // private Map<String, StopArea> stopAreasDictionary = new HashMap<String,
   // StopArea>();
   // private Map<String, Timetable> timetablesDictionary = new HashMap<String,
   // Timetable>();
   ...
   private void changeBoardingPositionToQuay(Line line)
   {
      for (Route route : line.getRoutes())
      {
         for (StopPoint point : route.getStopPoints())
         {
            ...
            {
               point.getContainedInStopArea()
                     .setAreaType(ChouetteAreaEnum.Quay);
            }
         }
      }
