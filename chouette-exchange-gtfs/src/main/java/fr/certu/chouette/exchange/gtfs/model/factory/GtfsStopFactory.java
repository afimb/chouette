...
public class GtfsStopFactory extends GtfsBeanFactory<GtfsStop>
{
   ...
   @Getter
   private final String createSql = "create table stop (num, id, code,name,desc,lat,lon,zoneid,url,locationtype,parentstation);";
   @Getter
   ...
   @Getter
   private final String selectSql = "select num, id, code,name,desc,lat,lon,zoneid,url,locationtype,parentstation from stop ";
   @Getter
