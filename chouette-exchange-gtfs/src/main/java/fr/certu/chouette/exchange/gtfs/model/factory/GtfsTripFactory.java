...
public class GtfsTripFactory extends GtfsBeanFactory<GtfsTrip>
{
   ...
   @Getter
   private final String dropSql = "drop table if exists trip;";
   @Getter
   private final String createSql = "create table trip (num, id, routeid,serviceid,headsign,shortname,directionid,blockid,shapeid);";
   @Getter
   private final String createIndexSql = "create index trip_id_idx on trip (id)";
   @Getter
   private final String createParentIndexSql = "create index trip_routeid_idx on trip (routeid)";
   ...
   @Getter
   private final String selectSql = "select num, id, routeid,serviceid,headsign,shortname,directionid,blockid,shapeid from trip ";
   @Getter
         ...
         Report report)
   {
      ...
      if (!bean.isValid())
      {
         ...
         {
            logger.warn("trips.txt : Line " + lineNumber
