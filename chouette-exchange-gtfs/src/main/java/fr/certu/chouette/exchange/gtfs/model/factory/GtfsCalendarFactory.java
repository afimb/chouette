...
public class GtfsCalendarFactory extends GtfsBeanFactory<GtfsCalendar>
{
   ...
   private static final Logger logger = Logger
         .getLogger(GtfsCalendarFactory.class);

   @Getter
   private final String dropSql = "drop table if exists calendar;";
   @Getter
   private final String createSql = "create table calendar (num, id, monday,tuesday,wednesday,thursday,friday,saturday,sunday,startdate,enddate);";
   @Getter
   private final String createIndexSql = "create index calendar_id_idx on calendar (id)";
   ...
   @Getter
   private final String selectSql = "select num, id, monday,tuesday,wednesday,thursday,friday,saturday,sunday,startdate,enddate from calendar ";
   @Getter
   private final String[] dbHeader = new String[] { "num", "service_id",
         ...
         Report report)
   {
      ...
      if (!bean.isValid())
      {
         ...
         {
            logger.warn("calendar.txt : Line " + lineNumber
   ...
   {
      // id,
      // monday,tuesday,wednesday,thursday,friday,saturday,sunday,startdate,enddate
      try
      {
