...
public class GtfsStopTimeFactory extends GtfsBeanFactory<GtfsStopTime>
{
   ...
   private static final Logger logger = Logger
         .getLogger(GtfsStopTimeFactory.class);
   @Getter
   private final String dropSql = "drop table if exists stoptime;";
   @Getter
   private final String createSql = "create table stoptime (num, tripid, arrivaltime,departuretime,stopid,stopsequence,stopheadsign,pickuptype,dropoftype,shapedisttraveled);";
   @Getter
   private final String createParentIndexSql = "create index stoptime_tripid_idx on stoptime (tripid)";
   ...
   @Getter
   private final String selectSql = "select num, tripid, arrivaltime,departuretime,stopid,stopsequence,stopheadsign,pickuptype,dropoftype,shapedisttraveled from stoptime ";
   @Getter
   private final String[] dbHeader = new String[] { "num", "trip_id",
         ...
         Report report)
   {
      ...
      if (!bean.isValid())
      {
         ...
         {
            logger.warn("stop_times.txt : Line " + lineNumber
   ...
   {
      // tripid,
      // arrivaltime,departuretime,stopid,stopsequence,stopheadsign,pickuptype,dropoftype,shapedisttraveled
      try
      {
