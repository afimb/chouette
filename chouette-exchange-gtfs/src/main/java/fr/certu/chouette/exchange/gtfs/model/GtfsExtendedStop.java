...
public class GtfsExtendedStop extends GtfsStop
{
	...
	@Getter @Setter private String     addressLine = null;
	@Getter @Setter private String     locality = null;
	@Getter @Setter private String     postalCode = null;
	
	// extension active only when partial exchange on stop

	public static final String header = GtfsStop.header+",address_line,locality,postal_code";
