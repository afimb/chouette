...
public class GtfsImportStopAreaPlugin implements IImportPlugin<StopArea>
{
   private static final Logger logger = Logger
         .getLogger(GtfsImportStopAreaPlugin.class);
   ...
   @Override
   public List<StopArea> doImport(List<ParameterValue> parameters,
         ...
         throws ChouetteException
   {
      ...
      try
      {
         ...
         if (ok)
         {
            ...
            converter.convertStopAreas(data, report, areas, commercials,
                  mapStopAreasByStopId, maxDistanceForCommercialStop,
            ...
            // report objects count
            {
               ExchangeReportItem countItem = new ExchangeReportItem(
                     ExchangeReportItem.KEY.LINE_COUNT, Report.STATE.OK, 0);
               report.addItem(countItem);
               countItem = new ExchangeReportItem(
                     ExchangeReportItem.KEY.ROUTE_COUNT, Report.STATE.OK, 0);
               report.addItem(countItem);
               countItem = new ExchangeReportItem(
