...
public class TimetableProducer extends AbstractCSVNeptuneProducer<Timetable>
{
   ...
   public List<String[]> produce(Timetable timetable, Report report)
   {
      ...
      csvLinesList.add(createCSVLine(TIMETABLE_LABEL_TITLE,
      ...
      csvLinesList.add(createCSVLine(MONDAY_TITLE,
            getDayTypeString(timetableDayTypes, DayTypeEnum.Monday)));
      csvLinesList.add(createCSVLine(TUESDAY_TITLE,
            getDayTypeString(timetableDayTypes, DayTypeEnum.Tuesday)));
      csvLinesList.add(createCSVLine(WEDNESDAY_TITLE,
            getDayTypeString(timetableDayTypes, DayTypeEnum.Wednesday)));
      csvLinesList.add(createCSVLine(THURSDAY_TITLE,
            getDayTypeString(timetableDayTypes, DayTypeEnum.Thursday)));
      csvLinesList.add(createCSVLine(FRIDAY_TITLE,
            getDayTypeString(timetableDayTypes, DayTypeEnum.Friday)));
      csvLinesList.add(createCSVLine(SATURDAY_TITLE,
            getDayTypeString(timetableDayTypes, DayTypeEnum.Saturday)));
      csvLinesList.add(createCSVLine(SUNDAY_TITLE,
            getDayTypeString(timetableDayTypes, DayTypeEnum.Sunday)));
   ...
   String getDayTypeString(List<DayTypeEnum> timetableDayTypes,
         DayTypeEnum dayType)
   {
   ...
   List<String[]> getPeriodsCSVLines(List<Period> timetablePeriods)
   {
      ...
      String[] startDates = new String[TITLE_COLUMN + 1
            + timetablePeriods.size()];
   ...
   {
      String[] calendarDaysCSVLine = new String[TITLE_COLUMN + 1
            + timetableCalendarDays.size()];
