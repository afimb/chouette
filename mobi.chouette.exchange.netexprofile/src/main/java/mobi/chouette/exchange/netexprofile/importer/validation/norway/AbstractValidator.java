...
public abstract class AbstractValidator implements Constant {
    ...
    protected void addValidationError(Context context, String checkPointKey) {
        addValidationError(context, checkPointKey, (DataLocation) null);
    }

    protected void addValidationError(Context context, String checkPointKey, DataLocation dataLocation) {
        ValidationReporter validationReporter = ValidationReporter.Factory.getInstance();
        validationReporter.addCheckPointReportError(context, checkPointKey, dataLocation);
