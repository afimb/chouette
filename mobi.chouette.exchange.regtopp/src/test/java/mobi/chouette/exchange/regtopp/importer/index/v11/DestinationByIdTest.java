...
public class DestinationByIdTest extends AbstractIndexTest{
	...
	public void testValidation() throws Exception {
		FileContentParser fileContentParser = createUnderlyingFileParser(new File("src/test/data/fullsets/kolumbus_v12/R5001.dst"), new Class[] {RegtoppDestinationDST.class});
