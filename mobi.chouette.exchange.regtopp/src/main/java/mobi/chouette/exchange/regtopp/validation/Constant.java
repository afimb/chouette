...
//	public static final String REGTOPP_INVALID_FIELD_VALUE = "1-REGTOPP-FIELD-VALUE-1";
	...
	public static final String REGTOPP_FILE_DKO = "1-REGTOPP-DKO-1";
	public static final String REGTOPP_FILE_GAV = "1-REGTOPP-GAV-1";
	public static final String REGTOPP_FILE_TMS = "1-REGTOPP-TMS-1";
	public static final String REGTOPP_FILE_DST = "1-REGTOPP-DST-1";
	public static final String REGTOPP_FILE_MRK = "1-REGTOPP-MRK-1";
	public static final String REGTOPP_FILE_LIN = "1-REGTOPP-LIN-1";
	public static final String REGTOPP_FILE_TDA = "1-REGTOPP-TDA-1";
	public static final String REGTOPP_FILE_STP = "1-REGTOPP-STP-1";

	public static final String REGTOPP_TIX_INVALID_FIELD_VALUE = "2-REGTOPP-TIX-1";
	public static final String REGTOPP_TIX_INVALID_MANDATORY_ID_REFERENCE = "2-REGTOPP-TIX-2";
	public static final String REGTOPP_TIX_INVALID_OPTIONAL_ID_REFERENCE = "2-REGTOPP-TIX-3";
	public static final String REGTOPP_TIX_DUPLICATE_KEY = "2-REGTOPP-TIX-4";
