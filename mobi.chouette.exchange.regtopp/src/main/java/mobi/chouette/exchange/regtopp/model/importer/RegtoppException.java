...
public class RegtoppException extends RuntimeException {
	...
	public RegtoppException(String path, Integer id, String field, ERROR error, String code, String value) {
	...
	public RegtoppException(String path, Integer id, Integer column, String field, ERROR error, String code, String value) {
