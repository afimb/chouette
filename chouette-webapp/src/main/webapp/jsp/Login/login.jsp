                    ...
                    <tr>
                        <td class="ministere">
                            <a href="http://www.equipement.gouv.fr/" target="_blank" class="medad">
                                <img alt="Visiter le site du Minist�re de l'Ecologie, du D�veloppement Durable, des Transports et du Logement" src="<%=request.getContextPath()%>/images/logoMedad.gif">
                            </a>
                        </td>
                        <td class="partners">
                            <a href="http://www.certu.fr" target="_blank" class="certu">
                                <img alt="Visiter le site du Centre d'Etudes sur les R�seaux, les Transports, l'Urbanisme et les constructions publiques" src="<%=request.getContextPath()%>/images/logoCertuSmall.gif">
                            </a>
                            <a href="http://www.predim.org" target="_blank" class="predim">
                                <img alt="Visiter le site de la Plate-forme de Recherche et d'Exp�rimentation pour le D�veloppement de l'information Multimodale" src="<%=request.getContextPath()%>/images/logoPredim.gif">
                            </a>
                        </td>
                        <td class="logo">
