    ...
    <tr>
      <td class="ministere">
        <a href="http://www.ecologie.gouv.fr/developpement-durable" target="_blank" class="medad">
          <img alt="Visiter le site du Ministère de l'Ecologie, du Développement et de l'Aménagement Durable" src="<s:url value='/images/logoMedad.gif'/>">
        </a>
      </td>
      <td class="partners">
        <a href="http://www.certu.fr" target="_blank" class="certu">
          <img alt="Visiter le site du Centre d'Etudes sur les Réseaux, les Transports, l'Urbanisme et les constructions publiques" src="<s:url value='/images/logoCertuSmall.gif'/>">
        </a>
        <a href="http://www.predim.org" target="_blank" class="predim">
          <img alt="Visiter le site de la Plate-forme de Recherche et d'Expérimentation pour le Développement de l'information Multimodale" src="<s:url value='/images/logoPredim.gif'/>">
        </a>
      </td>
      <td class="logo">
