...
public class NetexExporterInputValidatorTests {
	@SuppressWarnings("deprecation")
	@Test(groups = { "InputValidator" }, description = "test good inputs")
	public void verifyGoodInputs() throws Exception
	{
		NetexExporterInputValidator validator = new NetexExporterInputValidator();
		NetexExportParameters parameters = new NetexExportParameters();
