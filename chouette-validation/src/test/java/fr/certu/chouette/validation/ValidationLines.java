		...
		for (ReportItem item : report.getItems()) 
		{
			...
			if (checkPointReport.getMessageKey().equals("3-Line-1"))
			{
				...
				for (ReportItem ditem : checkPointReport.getItems()) 
				{
					...
					if (detailReport.getObjectId().equals(line1.getObjectId())) line1objectIdFound = true;
					if (detailReport.getObjectId().equals(line2.getObjectId())) line2objectIdFound = true;
					if (detailReport.getObjectId().equals(line3.getObjectId())) line3objectIdFound = true;
				}
				Assert.assertTrue(line1objectIdFound,"detail report must refer line 1");
				Assert.assertTrue(line2objectIdFound,"detail report must refer line 2");
				Assert.assertFalse(line3objectIdFound,"detail report must not refer line 3");
			}
		}
