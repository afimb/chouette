...
//						ReportItem detailReportItem = new DetailReportItem("Test2_Sheet12_Step1_error", Report.STATE.ERROR, restrictionConstraint.getName(), restrictionConstraint.getAreaId());
...
//		List<RestrictionConstraint> unvalidRestrictionConstraints = StopArea.getUnvalidRestrictionConstraints();
//		if (unvalidRestrictionConstraints != null) {
//			for (RestrictionConstraint unvalidRestrictionConstraint : unvalidRestrictionConstraints) {
//				ReportItem detailReportItem = new DetailReportItem("Test2_Sheet12_Step1_error", Report.STATE.ERROR, unvalidRestrictionConstraint.getName(), unvalidRestrictionConstraint.getAreaId());
//				report2_12.addItem(detailReportItem);
//				if (unvalidRestrictionConstraint.getLineIdShortCut() != null) {
//					if (unvalidRestrictionConstraint.getLine() == null) {
//						ReportItem detailReportItem2 = new DetailReportItem("Test2_Sheet13_Step1_error", Report.STATE.ERROR);
//						report2_13.addItem(detailReportItem2);
//					} else {
//						report2_13.updateStatus(Report.STATE.OK);
//					}
//				}
