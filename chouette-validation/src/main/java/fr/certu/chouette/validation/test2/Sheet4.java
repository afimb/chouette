	...
	private ReportItem step_2_4_1(List<ConnectionLink> connectionLinks){
		...
		for(ConnectionLink connectionLink : connectionLinks){
			...
			if(startOfLink == null || endOfLink == null){
				ReportItem detailReportItem = new DetailReportItem("Test2_Sheet4_Step1_error.a",STATE.ERROR, "");
				...
				ReportItem detailReportItem = new DetailReportItem("Test2_Sheet4_Step1_error.b",STATE.ERROR,startOfLink,endOfLink);
				report.addItem(detailReportItem);
			}else {
