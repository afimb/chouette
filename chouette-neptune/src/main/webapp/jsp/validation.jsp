...
<title><s:text name="text.validation.list.title" />
</title>
<s:url id="urlValidations" action="Validation_execute"
	includeParams="none" />
<s:property
	value="filAriane.addElementFilAriane(getText('text.validation.list.title'), '', #urlValidations)" />
<div class="panelData">
...
<div>
	<s:if test="useValidation == 'true'">
		<FIELDSET style="width: 500px;">
			<LEGEND>
				<b><s:text name="title.validate.data" />
				</b>
			</LEGEND>
