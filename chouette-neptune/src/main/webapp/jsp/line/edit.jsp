...
<div class="editLine">
  <s:form theme="css_xhtml" id="line">
    ...
    <s:select key="idReseau" required="true" name="idReseau" label="%{getText('idReseau')}" value="%{ptNetwork.id}" list="reseaux" listKey="id" listValue="name" headerKey="-1" headerValue="%{getText('aucunReseau')}">
    </s:select>
