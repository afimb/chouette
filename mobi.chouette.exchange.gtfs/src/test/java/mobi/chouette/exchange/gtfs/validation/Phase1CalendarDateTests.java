...
public class Phase1CalendarDateTests extends AbstractPhase1Tests {
	...
	public void verifyTest_2_2_1() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "calendar_date_2_1", GTFS_1_GTFS_Common_3_1,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_2_2() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "calendar_date_2_2", GTFS_1_GTFS_Common_3_1,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_2_3() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "calendar_date_2_3", GTFS_1_GTFS_Common_3_1,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_3_1() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "calendar_date_3_1", GTFS_1_GTFS_Common_4,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_3_2() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "calendar_date_3_2", GTFS_1_GTFS_Common_4,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_3_3() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "calendar_date_3_3", GTFS_1_GTFS_Common_4,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_4() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "calendar_date_4", GTFS_2_GTFS_Common_4,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_5() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "calendar_date_5", GTFS_1_GTFS_Common_5,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_6() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "calendar_date_6", GTFS_1_GTFS_Common_5,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_7() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "calendar_date_7", GTFS_1_GTFS_Common_3_4,CheckPoint.SEVERITY.WARNING, CheckPoint.RESULT.NOK,true);
