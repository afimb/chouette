...
public class Phase2CalendarTests extends AbstractPhase2Tests {
	...
	public void verifyTest_2_2() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "calendar_2", GTFS_1_GTFS_Common_4_2,CheckPoint.SEVERITY.WARNING, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_3_3() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "calendar_3_2", GTFS_2_GTFS_Calendar_3,CheckPoint.SEVERITY.WARNING, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_4() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "calendar_4", GTFS_2_GTFS_Calendar_4,CheckPoint.SEVERITY.WARNING, CheckPoint.RESULT.NOK,true);
