...
public class Phase2AgencyTests extends ValidationTests {
	...
	public void verifyTest_2_1() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "agency_1", "1-GTFS-Agency-1",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
...
//		CheckPoint result = verifyValidation( log, "agency_2", "1-GTFS-Agency-2",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
...
//		CheckPoint result = verifyValidation( log, "agency_3", "1-GTFS-Agency-3",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
...
//		CheckPoint result = verifyValidation( log, "agency_4_1", "1-GTFS-Agency-4",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
...
//		CheckPoint result = verifyValidation( log, "agency_4_2", "1-GTFS-Agency-4",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
...
//		CheckPoint result = verifyValidation( log, "agency_4_3", "1-GTFS-Agency-4",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
...
//		CheckPoint result = verifyValidation( log, "agency_4_4", "1-GTFS-Agency-4",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
...
//		CheckPoint result = verifyValidation( log, "agency_5_1", "1-GTFS-Agency-5",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
...
//		CheckPoint result = verifyValidation( log, "agency_5_2", "1-GTFS-Agency-5",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
...
//		}
//	}
//	@Test(groups = { "Phase 2 Agency" }, description = "empty column agency_timezonel" ,priority=10 )
//	public void verifyTest_2_5_3() throws Exception {
//		log.info(Color.GREEN + "Agency_5_3 : empty column agency_timezonel" + Color.NORMAL);
//		CheckPoint result = verifyValidation( log, "agency_5_3", "1-GTFS-Agency-5",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
