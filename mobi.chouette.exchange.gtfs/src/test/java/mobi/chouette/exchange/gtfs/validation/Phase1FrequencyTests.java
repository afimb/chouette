...
public class Phase1FrequencyTests extends AbstractPhase1Tests {
	...
	public void verifyTest_2_1_1() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "frequency_1_1", GTFS_1_GTFS_Common_3_1,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_1_2() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "frequency_1_2", GTFS_1_GTFS_Common_3_1,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_1_3() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "frequency_1_3", GTFS_1_GTFS_Common_3_1,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_1_4() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "frequency_1_4", GTFS_1_GTFS_Common_3_1,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_2_1() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "frequency_2_1", GTFS_1_GTFS_Common_4,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_2_2() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "frequency_2_2", GTFS_1_GTFS_Common_4,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_2_3() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "frequency_2_3", GTFS_1_GTFS_Common_4,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_2_4() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "frequency_2_4", GTFS_1_GTFS_Common_4,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_3() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "frequency_3", GTFS_1_GTFS_Common_5,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_4() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "frequency_4", GTFS_1_GTFS_Common_5,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_5() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "frequency_5", GTFS_1_GTFS_Common_5,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_6() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "frequency_6", GTFS_1_GTFS_Common_5,CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_7() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "frequency_7", GTFS_1_GTFS_Common_3_4,CheckPoint.SEVERITY.WARNING, CheckPoint.RESULT.NOK,true);
