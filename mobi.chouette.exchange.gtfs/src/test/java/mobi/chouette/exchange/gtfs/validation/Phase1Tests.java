...
public class Phase1Tests extends ValidationTests {
	...
	public void verifyTest_1_1() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "csv_1_1", "1-GTFS-CSV-10",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
...
//		CheckPoint result = verifyValidation( log, "csv_1_2", "1-GTFS-CSV-13",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
...
//		CheckPoint result = verifyValidation( log, "csv_1_3", "1-GTFS-CSV-13",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
...
//		CheckPoint result = verifyValidation( log, "csv_1_4", "1-GTFS-CSV-7",CheckPoint.SEVERITY.WARNING, CheckPoint.RESULT.NOK);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
...
//		CheckPoint result = verifyValidation( log, "csv_1_5", "1-GTFS-CSV-13",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
...
//		CheckPoint result = verifyValidation( log, "csv_1_6", "1-GTFS-CSV-13",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
...
//		CheckPoint result = verifyValidation( log, "csv_1_7", "1-GTFS-CSV-11",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
...
//		CheckPoint result = verifyValidation( log, "csv_1_8", "1-GTFS-CSV-12",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
