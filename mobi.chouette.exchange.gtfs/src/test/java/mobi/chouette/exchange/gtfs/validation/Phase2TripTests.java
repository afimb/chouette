...
public class Phase2TripTests extends AbstractPhase2Tests {
	...
	public void verifyTest_2_1() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "trip_1", "2-GTFS-Trip-1",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	public void verifyTest_2_2() throws Exception {
		...
		CheckPoint result = verifyValidation( log, "trip_2", "2-GTFS-Trip-2",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
	...
	@Test(groups = { "Phase 2 Trip" }, description = "unknown shape_id with shape.txt missing" ,priority=342 )
	public void verifyTest_2_3_1() throws Exception {
		log.info(Color.GREEN + "Trip_3 : unknown shape_id with shape.txt missing" + Color.NORMAL);
		CheckPoint result = verifyValidation( log, "trip_3_1", "2-GTFS-Trip-3",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
...
//	@Test(groups = { "Phase 2 Trip" }, description = "unknown shape_id with shape.txt present" ,priority=343 )
//	public void verifyTest_2_3_2() throws Exception {
//		log.info(Color.GREEN + "Trip_3 : unknown shape_id with shape.txt present" + Color.NORMAL);
//		CheckPoint result = verifyValidation( log, "trip_3_2", "2-GTFS-Trip-3",CheckPoint.SEVERITY.ERROR, CheckPoint.RESULT.NOK,true);
//
//		Assert.assertEquals(result.getDetailCount(), 1, "detail count");
//		for (Detail detail : result.getDetails()) 
//		{
