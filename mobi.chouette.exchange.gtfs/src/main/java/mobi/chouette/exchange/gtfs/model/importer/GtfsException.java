...
public class GtfsException extends RuntimeException {
	...
	public enum ERROR {
		...
		INVALID_TIMEPOINT,
		INVALID_DIRECTION,
		INVALID_WHEELCHAIR_TYPE,
		INVALID_BYKE_TYPE,
		INVALID_EXACT_TIMES_VALUE,
		INVALID_START_TIME,
		INVALID_END_TIME,
		INVALID_HEADWAY_SECS,
		INVALID_MONDAY_TYPE,
		INVALID_TUESDAY_TYPE,
		INVALID_WEDNESDAY_TYPE,
		INVALID_THURSDAY_TYPE,
		INVALID_FRIDAY_TYPE,
		INVALID_SATURDAY_TYPE,
		INVALID_SUNDAY_TYPE,
		INVALID_START_DATE,
		INVALID_END_DATE,
