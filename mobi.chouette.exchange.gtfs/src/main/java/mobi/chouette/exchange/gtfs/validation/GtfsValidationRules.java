...
//		checkPoints.add(new CheckPoint(GTFS_1_GTFS_CSV_14, CheckPoint.RESULT.UNCHECK, CheckPoint.SEVERITY.ERROR));
	...
	private Collection<? extends CheckPoint> commonCheckPoints() {
		...
		checkPoints.add(new CheckPoint(GTFS_1_GTFS_Common_3_1 , CheckPoint.RESULT.UNCHECK, CheckPoint.SEVERITY.WARNING));
		checkPoints.add(new CheckPoint(GTFS_1_GTFS_Common_3_2 , CheckPoint.RESULT.UNCHECK, CheckPoint.SEVERITY.WARNING));
		...
		checkPoints.add(new CheckPoint(GTFS_1_GTFS_Common_4_1 , CheckPoint.RESULT.UNCHECK, CheckPoint.SEVERITY.WARNING));
		checkPoints.add(new CheckPoint(GTFS_1_GTFS_Common_4_2 , CheckPoint.RESULT.UNCHECK, CheckPoint.SEVERITY.WARNING));
		checkPoints.add(new CheckPoint(GTFS_1_GTFS_Common_4_3 , CheckPoint.RESULT.UNCHECK, CheckPoint.SEVERITY.WARNING));
		checkPoints.add(new CheckPoint(GTFS_1_GTFS_Common_4_4 , CheckPoint.RESULT.UNCHECK, CheckPoint.SEVERITY.WARNING));
		checkPoints.add(new CheckPoint(GTFS_1_GTFS_Common_4_5 , CheckPoint.RESULT.UNCHECK, CheckPoint.SEVERITY.WARNING));
		checkPoints.add(new CheckPoint(GTFS_1_GTFS_Common_4_6 , CheckPoint.RESULT.UNCHECK, CheckPoint.SEVERITY.WARNING));
		checkPoints.add(new CheckPoint(GTFS_1_GTFS_Common_4_7 , CheckPoint.RESULT.UNCHECK, CheckPoint.SEVERITY.WARNING));

		checkPoints.add(new CheckPoint(GTFS_1_GTFS_Common_5   , CheckPoint.RESULT.UNCHECK, CheckPoint.SEVERITY.WARNING));
...
//		checkPoints.add(new CheckPoint(GTFS_1_GTFS_StopTime_13, CheckPoint.RESULT.UNCHECK, CheckPoint.SEVERITY.WARNING));
//		checkPoints.add(new CheckPoint(GTFS_1_GTFS_StopTime_14, CheckPoint.RESULT.UNCHECK, CheckPoint.SEVERITY.ERROR));
//		return checkPoints;
//	}
//	
