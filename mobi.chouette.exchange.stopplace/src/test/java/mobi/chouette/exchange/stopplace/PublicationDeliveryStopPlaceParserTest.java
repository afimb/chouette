...
public class PublicationDeliveryStopPlaceParserTest {
    ...
    public void testParseStopPlacesFromPublicationDelivery() throws Exception {
        ...
        Map<String, String> mergedQueys = parser.getUpdateContext().getMergedQuays();
        Assert.assertEquals(mergedQueys.size(), 3);
        Assert.assertEquals(mergedQueys.get("NSR:Quay:11002"), "NSR:Quay:11001a", "Quays should have been merged");
        Assert.assertEquals(mergedQueys.get("NSR:Quay:11003"), "NSR:Quay:11001a", "Quays should have been merged");
        Assert.assertEquals(mergedQueys.get("NSR:Quay:11004"), "NSR:Quay:11001b", "Quays should have been merged");
    }
}
