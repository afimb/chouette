...
import mobi.chouette.exchange.generic.JobDataTest;
...
public class GenericExporterCommandTest extends Arquillian implements mobi.chouette.common.Constant {
	...
	protected Context initImportContext() {
		...
		GenericExportParameters configuration = new GenericExportParameters();
	...
	public void transferDataToNewTenant() throws Exception {
		...
		Command command = CommandFactory.create(initialContext, GenericExporterCommand.class.getName());

		boolean genericExportCommandResult = command.execute(context);
		Assert.assertTrue(genericExportCommandResult);
