...
import mobi.chouette.exchange.kml.exporter.KmlExporterInputValidator;
import mobi.chouette.exchange.parameters.AbstractExportParameter;

import org.testng.Assert;
import org.testng.annotations.Test;

public class KmlExporterInputValidatorTests {
	@SuppressWarnings("deprecation")
	@Test(groups = { "InputValidator" }, description = "test good inputs")
	public void verifyGoodInputs() throws Exception
	{
		KmlExporterInputValidator validator = new KmlExporterInputValidator();
		KmlExportParameters parameters = new KmlExportParameters();
