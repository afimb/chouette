...
import mobi.chouette.exchange.neptune.exporter.NeptuneExporterInputValidator;
import mobi.chouette.exchange.parameters.AbstractExportParameter;

import org.testng.Assert;
import org.testng.annotations.Test;

public class NeptuneExporterInputValidatorTests {
	@SuppressWarnings("deprecation")
	@Test(groups = { "InputValidator" }, description = "test good inputs")
	public void verifyGoodInputs() throws Exception
	{
		NeptuneExporterInputValidator validator = new NeptuneExporterInputValidator();
		NeptuneExportParameters parameters = new NeptuneExportParameters();
