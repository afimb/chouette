...
public class Phase2CommonTests extends ValidationTests {
	...
	public void verifyTest_0_OK() throws Exception {
		...
		verifyValidation( "Ligne_OK.xml", "NONE",null , RESULT.OK);
	...
	public void verifyTest_2_Common_1_1() throws Exception {
		...
		verifyCrossValidation( "2-NEPTUNE-Common-1-1.zip", "2-NEPTUNE-Common-1", RESULT.NOK);
	...
	public void verifyTest_2_Common_1_2() throws Exception {
		...
		verifyCrossValidation( "2-NEPTUNE-Common-1-2.zip", "2-NEPTUNE-Common-1", RESULT.NOK);
	...
	public void verifyTest_2_Common_1_3() throws Exception {
		...
		verifyCrossValidation( "2-NEPTUNE-Common-1-3.zip", "2-NEPTUNE-Common-1", RESULT.NOK);
	...
	public void verifyTest_2_Common_2() throws Exception {
		...
		verifyCrossValidation( "2-NEPTUNE-Common-2.zip", "2-NEPTUNE-Common-2", RESULT.NOK);
