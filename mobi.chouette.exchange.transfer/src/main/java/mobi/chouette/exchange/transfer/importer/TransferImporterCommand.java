...
@Log4j
@Stateless(name = TransferImporterCommand.COMMAND)
public class TransferImporterCommand extends AbstractExporterCommand implements Command, Constant, ReportConstant {
	...
	public static final String COMMAND = "TransferImporterCommand";
	...
	static {
		CommandFactory.factories.put(TransferImporterCommand.class.getName(), new DefaultCommandFactory());
	}
}
