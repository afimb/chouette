...
{
	public static enum ATTR_CMD {SET_VALUE, ADD_VALUE, REMOVE_VALUE,SET_REF,ADD_REF,REMOVE_REF};
	 ...
	 * @return
	 */
	public final String getSimpleString(Map<String, List<String>> parameters,String key)
	{
	 ...
	 * @return
	 */
	public final String getSimpleString(Map<String, List<String>> parameters,String key,String defaultValue)
	{
		List<String> values = parameters.get(key);
	 ...
	 * @return
	 */
	public final boolean getBoolean(Map<String, List<String>> parameters,String key)
	{
		List<String> values = parameters.get(key);
