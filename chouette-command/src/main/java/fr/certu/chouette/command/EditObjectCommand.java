...
public class EditObjectCommand extends AbstractCommand
{
   ...
   private static final Logger logger = Logger
         .getLogger(EditObjectCommand.class);
   ...
   protected Calendar toCalendar(String simpleval)
   {
      ...
      {
         logger.error("invalid date format : " + simpleval
               + " dd/MM/yyyy expected");
    ...
    * @throws Exception
    */
   public void executeSet(List<NeptuneIdentifiedObject> beans,
    ...
    * @throws Exception
    */
   public void executeAdd(List<NeptuneIdentifiedObject> beans,
         Map<String, List<String>> parameters) throws Exception
   {
    ...
    * @throws Exception
    */
   public void executeRemove(List<NeptuneIdentifiedObject> beans,
         Map<String, List<String>> parameters) throws Exception
   {
    ...
    * @throws Exception
    */
   private void updateAttribute(String cmd,
         List<NeptuneIdentifiedObject> beans,
         Map<String, List<String>> parameters) throws Exception
   {
      if (beans.size() == 0)
      {
      ...
      if (args != null)
      {
         ...
         {
            throw new Exception(
                  "command set -attr : missing arguments : name value");
         }
      ...
      } else
      {
         ...
         {
            throw new Exception(
                  "command set -ref : missing arguments : ref objectId");
         }
         String attrname = args.get(0);
         String value = null;
         if (args.size() > 1)
    ...
    * @throws Exception
    */
   public void executeInfo(INeptuneManager<NeptuneIdentifiedObject> manager)
         throws Exception
   {
    ...
    * @throws Exception
    */
   private void printField(Class<?> objectType, Field field, String indent)
         throws Exception
   {
      ...
      } else
      {
         if (type.getSimpleName().equals("List"))
         {
            ...
            System.out.print(" : collection of type "
         ...
         String value) throws Exception
   {
      if (attrname.contains("."))
      {
         ...
         {
            String srank = basename.substring(basename.indexOf("[") + 1,
                  basename.indexOf("]"));
            ...
            } else
            {
               ...
               } else
               {
                  ...
                  {
                     throw new Exception("index " + rank
                           + " out of collection bounds " + collection.size());
                  }
   ...
   private void removeAttribute(Object object, String attrname, String value)
         throws Exception
   {
   ...
   private void addAttribute(Object object, String attrname, String value)
         throws Exception
   {
      Class<?> beanClass = object.getClass();
      Method adder = findAdder(beanClass, attrname);
    ...
    * @throws Exception
    */
   private void setAttribute(Object object, String attrname, String value)
         throws Exception
   {
      ...
      {
         throw new Exception(
               "non writable attribute id for any object , process stopped ");
      }
      if (!name.equals("objectid") && !name.equals("creatorid")
            && !name.equals("areacentroid") && name.endsWith("id"))
      {
         throw new Exception("non writable attribute " + attrname
               + " use setReference instand , process stopped ");
      }
      Class<?> beanClass = object.getClass();
      ...
      {
         throw new Exception("list attribute " + attrname + " for object "
               + beanClass.getName()
    ...
    * @throws Exception
    */
   private void setReference(Object object, String refName, String objectId)
         throws Exception
   {
      Class<?> beanClass = object.getClass();
    ...
    * @throws Exception
    */
   private void addReference(Object object, String refName, String objectId)
         throws Exception
   {
      Class<?> beanClass = object.getClass();
    ...
    * @throws Exception
    */
   private void removeReference(Object object, String refName, String objectId)
         throws Exception
   {
      Class<?> beanClass = object.getClass();
         ...
         throws Exception
   {
      ...
      {
         throw new Exception(typeName + " with ObjectId = " + objectId
               + " does not exists");
      }
   }
    ...
    * @throws Exception
    */
   private Method findSetter(Class<?> beanClass, String attribute)
         throws Exception
   {
    ...
    * @throws Exception
    */
   private Method findAccessor(Class<?> beanClass, String attribute,
         String prefix, boolean ex) throws Exception
   {
      ...
      if (ex && accessor == null)
      {
         throw new Exception("unknown accessor " + prefix + " for attribute "
               + attribute + " for object " + beanClass.getName()
               + ", process stopped ");
      }
      return accessor;
   }
    ...
    * @throws Exception
    */
   private Method findGetter(Class<?> beanClass, String attribute)
         throws Exception
   {
    ...
    * @throws Exception
    */
   private Method findAdder(Class<?> beanClass, String attribute)
         throws Exception
   {
    ...
    * @throws Exception
    */
   private Method findRemover(Class<?> beanClass, String attribute,
         Class<?> argType) throws Exception
   {
      ...
      if (accessor == null)
      {
         throw new Exception("unknown accessor remove for attribute "
               + attribute + " for object " + beanClass.getName()
               + " with argument type = " + argType.getSimpleName()
               + ", process stopped ");
      }
      return accessor;
   }
   ...
   private Object toObject(Class<?> type, String value) throws Exception
   {
      ...
      throw new Exception("unable to convert String to "
   ...
   {
      if (value == null)
         throw new Exception("primitive type " + type.getName()
