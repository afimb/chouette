...
@XmlType(propOrder={"name","userName","organisationName","referentialName","defaultCodespace", "defaultFormat", "test"},name="actionParameters")
public class AbstractParameter {
	...
	@Getter@Setter
	@XmlElement(name = "default_codespace")
