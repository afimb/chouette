...
//	private static Collection<StopArea> getStopAreas(Referential referential) {
//		Set<StopArea> result = new HashSet<StopArea>();
//		for (StopPoint stopPoint : referential.getStopPoints().values()) {
//			result.add(stopPoint.getContainedInStopArea());
//		}
//		return result;
//	}
//
//	private static Collection<Timetable> getTimetables(Referential referential) {
//		Set<Timetable> result = new HashSet<Timetable>();
//		for (VehicleJourney vehicleJourney : referential.getVehicleJourneys()
//				.values()) {
//			result.addAll(vehicleJourney.getTimetables());
//		}
//		return result;
//	}
//
//	private static Collection<PTNetwork> getPTNetworks(Referential referential) {
//		Set<PTNetwork> result = new HashSet<PTNetwork>();
//		for (Line line : referential.getLines().values()) {
//			result.add(line.getPtNetwork());
//		}
//		return result;
//	}
//
//	private static Collection<Company> getCompanies(Referential referential) {
//		Set<Company> result = new HashSet<Company>();
//		for (Line line : referential.getLines().values()) {
//			result.add(line.getCompany());
//		}
//		for (VehicleJourney vehicleJourney : referential.getVehicleJourneys()
//				.values()) {
//			result.add(vehicleJourney.getCompany());
//		}
//		return result;
//	}
//
//	private static Collection<GroupOfLine> getGroupOfLines(
//			Referential referential) {
//		Set<GroupOfLine> result = new HashSet<GroupOfLine>();
//		for (Line line : referential.getLines().values()) {
//			result.addAll(line.getGroupOfLines());
//		}
//		return result;
//	}
